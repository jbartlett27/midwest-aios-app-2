  ...
  return <div style={{minHeight:"100vh",background:"#fff",color:"#111",fontFamily:"'Satoshi',sans-serif"}}>
    <div style={{maxWidth:960,margin:"0 auto",padding:"32px 24px"}}>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:16}}>
        <div style={{display:"flex",alignItems:"center",gap:12}}><img src={MW_LOGO} alt="MW" style={{height:48,borderRadius:8}}/><div><div style={{fontSize:16,fontWeight:700}}>Midwest Educational Furnishings, Inc.</div><div style={{fontSize:11,color:"#888"}}>21191 N Valley Rd, Kildeer, IL 60047 US | (847) 847-1865</div></div></div>
