...
export default function MidwestAIOS() {
  ...
  return (
    <div style={{display:"flex",height:"100vh",width:"100vw",fontFamily:"'Satoshi','Satoshi',sans-serif",background:"#000000",color:"#d4d4d4",overflow:"hidden"}}>
      ...
      {/* Mobile hamburger */}
      {!mobileMenuOpen&&<div className="mobile-menu-btn" style={{display:"none",position:"fixed",bottom:16,left:"50%",transform:"translateX(-50%)",zIndex:10001,background:"rgba(12,12,12,0.45)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:28,padding:"8px 6px",backdropFilter:"blur(64px) saturate(200%) brightness(1.1)",WebkitBackdropFilter:"blur(64px) saturate(200%) brightness(1.1)",boxShadow:"0 8px 40px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.08), inset 0 -1px 0 rgba(255,255,255,0.02)"}}><div style={{display:"flex",gap:2}}>{[{id:"dashboard",icon:"dashboard",l:"Home"},{id:"jobs",icon:"briefcase",l:"Jobs"},{id:"documents",icon:"file",l:"Docs"},{id:"deliveries",icon:"truck",l:"Track"},{id:"brain",icon:"brain",l:"AI"}].map(t=><button key={t.id} onClick={()=>{setPage(t.id);setSelectedJob(null)}} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:2,padding:"6px 14px",borderRadius:20,border:"none",background:page===t.id?"rgba(45,212,191,0.18)":"transparent",color:page===t.id?"#2dd4bf":"#636363",cursor:"pointer",fontFamily:"'Satoshi',sans-serif",fontSize:9,fontWeight:page===t.id?600:400,transition:"all 0.3s cubic-bezier(0.4,0,0.2,1)",transform:page===t.id?"scale(1.05)":"scale(1)"}}><I n={t.icon} s={18}/>{t.l}</button>)}<button onClick={()=>setMobileMenuOpen(true)} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:2,padding:"6px 14px",borderRadius:20,border:"none",background:"transparent",color:"#525252",cursor:"pointer",fontFamily:"'Satoshi',sans-serif",fontSize:9,fontWeight:400}}><I n="settings" s={18}/>More</button></div></div>}
