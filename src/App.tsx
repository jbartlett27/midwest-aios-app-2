...
function JobDetail({job,ctx}){
  ...
  const [newItem,setNewItem]=useState({description:"",vendor:"",tag:"",manufacturer:"",modelNumber:"",color:"",listPrice:"",unitCost:"",unitPrice:"",shippingPerUnit:"",installPerUnit:"",qtyOrdered:"",qtyReceived:0,qtyInvoiced:0});
