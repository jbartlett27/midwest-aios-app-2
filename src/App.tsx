...
const INIT_VENDORS = [
  { id: "V001", name: "Smith System", contact: "Sales Dept", email: "info@smithsystem.com", phone: "(800) 328-1061", category: "Collaborative Tables", address: "1714 E 14th St, Plano, TX 75074", discountRate: 0.38, discountType: "percentage", discountNotes: "38% off list standard. 40% on orders over $25K." },
  { id: "V002", name: "Haskell Education", contact: "Sales Dept", email: "info@haskelleducation.com", phone: "(800) 334-8988", category: "Classroom Furniture", address: "1 Haskell Dr, Pittsburgh, PA 15205", discountRate: 0.35, discountType: "percentage", discountNotes: "35% off list. Free freight on $10K+." },
  { id: "V003", name: "National Public Seating", contact: "Sales Dept", email: "info@nps.com", phone: "(800) 235-5912", category: "Seating & Staging", address: "901 Janesville Ave, Fort Atkinson, WI 53538", discountRate: 0.40, discountType: "percentage", discountNotes: "40% off list. 45% on seating orders 200+ units." },
  { id: "V004", name: "KI", contact: "Sales Dept", email: "info@ki.com", phone: "(800) 424-2432", category: "Education & Office", address: "1330 Bellevue St, Green Bay, WI 54302", discountRate: 0.45, discountType: "percentage", discountNotes: "45% off list. Project pricing available on $50K+." },
  { id: "V005", name: "MooreCo", contact: "Sales Dept", email: "info@mooreco.com", phone: "(800) 749-2258", category: "Whiteboards & AV", address: "2885 Lorraine Ave, Temple, TX 76501", discountRate: 0.36, discountType: "percentage", discountNotes: "36% off list standard." },
  { id: "V006", name: "Jonti-Craft", contact: "Sales Dept", email: "info@jonti-craft.com", phone: "(800) 543-4149", category: "Early Childhood", address: "171 Highway 68, Wabasso, MN 56293", discountRate: 0.40, discountType: "percentage", discountNotes: "40% off list. Free freight on $5K+." },
  { id: "V007", name: "Bretford", contact: "Sales Dept", email: "info@bretford.com", phone: "(800) 521-9614", category: "Technology & Charging", address: "11000 Seymour Ave, Franklin Park, IL 60131", discountRate: 0.38, discountType: "percentage", discountNotes: "38% off list. Tech cart orders get additional 5% on 50+ units." },
  { id: "V008", name: "Diversified Spaces", contact: "Sales Dept", email: "info@diversifiedspaces.com", phone: "(800) 253-3684", category: "Science Lab Furniture", address: "Boyertown, PA 19512", discountRate: 0.35, discountType: "percentage", discountNotes: "35% off list. Custom lab builds priced per project." },
  { id: "V009", name: "Fleetwood", contact: "Sales Dept", email: "info@fleetwood.com", phone: "(800) 257-6390", category: "Classroom & Mobile", address: "Holland, MI 49423", discountRate: 0.37, discountType: "percentage", discountNotes: "37% off list. Mobile furniture lines." },
  { id: "V010", name: "Columbia Manufacturing", contact: "Sales Dept", email: "info@columbiamfg.com", phone: "(800) 882-3056", category: "Classroom Furniture", address: "Silver Creek, NY 14136", discountRate: 0.35, discountType: "percentage", discountNotes: "35% off list." },
  { id: "V011", name: "Scholar Craft", contact: "Sales Dept", email: "info@scholarcraft.com", phone: "(800) 225-7188", category: "Classroom Furniture", address: "Birmingham, AL 35210", discountRate: 0.40, discountType: "percentage", discountNotes: "40% off list. Competitive with Virco on basics." },
  { id: "V012", name: "Wenger", contact: "Sales Dept", email: "info@wengercorp.com", phone: "(800) 733-0393", category: "Music & Performing Arts", address: "555 Park Dr, Owatonna, MN 55060", discountRate: 0.30, discountType: "percentage", discountNotes: "30% off list. Music room specialty." },
  { id: "V013", name: "Palmer Hamilton", contact: "Sales Dept", email: "info@palmerhamilton.com", phone: "(800) 788-1028", category: "Cafeteria & Tables", address: "Elkhorn, WI 53121", discountRate: 0.36, discountType: "percentage", discountNotes: "36% off list. Cafeteria table specialist." },
  { id: "V014", name: "BioFit", contact: "Sales Dept", email: "info@biofit.com", phone: "(800) 597-0246", category: "Lab & STEM Seating", address: "Waterville, OH 43566", discountRate: 0.33, discountType: "percentage", discountNotes: "33% off list. Lab stool specialist." },
  { id: "V015", name: "Screenflex", contact: "Sales Dept", email: "info@screenflex.com", phone: "(800) 553-0110", category: "Room Dividers", address: "Lake Zurich, IL 60047", discountRate: 0.30, discountType: "percentage", discountNotes: "30% off list." },
  { id: "V016", name: "ECR4Kids", contact: "Sales Dept", email: "info@ecr4kids.com", phone: "(855) 327-4543", category: "Early Childhood", address: "San Diego, CA 92127", discountRate: 0.42, discountType: "percentage", discountNotes: "42% off list. Pre-K and elementary focus." },
];
