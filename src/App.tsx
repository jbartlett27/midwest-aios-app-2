...
function JobDetail({job,ctx}){
  ...
  const sigHtml='<div style="margin-top:48px;border-top:1px solid #e5e5e5;padding-top:24px"><div style="font-size:14px;font-weight:600;margin-bottom:16px">Approval</div><div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;margin-top:20px"><div><div style="border-bottom:1px solid #ccc;height:40px"></div><div style="font-size:11px;color:#999;margin-top:4px">Authorized Signature</div></div><div><div style="border-bottom:1px solid #ccc;height:40px"></div><div style="font-size:11px;color:#999;margin-top:4px">Date</div></div></div></div>';
  triggerPrint('Job Packet - '+job.name,coverHtml+'<div style="page-break-before:always"></div>'+quoteHtml+'<div style="page-break-before:always"></div>'+hd+poSections+'<div style="page-break-before:always"></div>'+hd+deliveryHtml+summaryHtml+sigHtml)}} style={{fontSize:12,padding:"6px 10px"}}><I n="download" s={12}/> Job Packet</Btn></div>
      </div>
