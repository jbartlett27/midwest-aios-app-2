...
function JobDetail({job,ctx}){
  ...
  return <div style={{animation:"fadeUp 0.4s cubic-bezier(0.25,0.1,0.25,1)"}}>
    ...
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:24}}>
      ...
      <div style={{display:"flex",gap:8,flexWrap:"wrap"}}><Btn v="danger" onClick={()=>deleteJob(job.id)} style={{fontSize:12}}><I n="close" s={14}/> Delete</Btn><Btn v="secondary" onClick={()=>setEditing(!editing)}><I n="edit" s={14}/> Edit</Btn><Btn v="secondary" onClick={duplicateJob} style={{fontSize:12}}><I n="package" s={14}/> Duplicate</Btn><Btn v="ghost" onClick={()=>{ctx.setPage("documents")}}><I n="file" s={14}/> Quote</Btn><Btn onClick={()=>setAddingItem(true)}><I n="plus" s={14}/> Add Item</Btn></div>
    </div>
