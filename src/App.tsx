...
const StatCard = ({label,value,sub,icon,color="#2dd4bf"}) => <Card style={{display:"flex",flexDirection:"column",gap:8,padding:"20px 24px"}}><span style={{fontSize:11,color:"#737373",fontWeight:600,textTransform:"uppercase",letterSpacing:2}}>{label}</span><div style={{fontSize:36,fontWeight:700,color:"#f0f0f0",fontFamily:"'JetBrains Mono',monospace",letterSpacing:-1,lineHeight:1}}>{value}</div>{sub&&<div style={{fontSize:12,color:"#525252",marginTop:2}}>{sub}</div>}</Card>;
