...
function JobDetail({job,ctx}){
  const {getJobFinancials,getJobItems,getItemStatus,vendors,customers,reps,updateJob,addJob,addLineItem,updateLineItem,deleteLineItem,deleteJob,setSelectedJob,notify,lineItems,jobs,triggerPrint}=ctx;
  ...
  const coverHtml='<div style="text-align:center;padding:120px 0 60px"><img src="'+MW_LOGO+'" style="height:60px;margin-bottom:24px"/><div style="font-size:28px;font-weight:800;margin-bottom:8px">'+job.name+'</div><div style="font-size:16px;color:#666;margin-bottom:4px">'+(customer2?.name||'')+'</div><div style="font-size:14px;color:#999;margin-bottom:8px">Prepared by Midwest Educational Furnishings</div>'+(job.terms?'<div style="font-size:12px;color:#999;margin-bottom:4px">Terms: '+job.terms+'</div>':'')+'<div style="font-size:12px;color:#999;margin-bottom:40px">'+(job.shipTo?'Ship To: '+job.shipTo:'')+'</div><div style="font-size:12px;color:#999">'+(new Date().toLocaleDateString())+'</div></div>';
  ...
  triggerPrint('Job Packet - '+job.name,coverHtml+'<div style="page-break-before:always"></div>'+quoteHtml+'<div style="page-break-before:always"></div><h2 style="color:#2563eb;border-bottom:2px solid #2563eb;padding-bottom:8px">PURCHASE ORDERS</h2>'+poSections+'<div style="page-break-before:always"></div>'+deliveryHtml+summaryHtml+sigHtml)}} style={{fontSize:11,padding:"6px 10px"}}><I n="download" s={12}/> Job Packet</Btn></div>
    ...
    <div className="resp-grid-5" style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:12,marginBottom:24}}>
      ...
      <Card style={{padding:12}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><span style={{fontSize:11,color:"#525252"}}>Terms</span><span style={{fontSize:12,fontWeight:600,color:"#2dd4bf"}}>{job.terms||"Net 30"}</span></div></Card>
