...
// MIDWEST EDUCATIONAL FURNISHINGS Ã¢ÂÂ AI OPERATING SYSTEM v2
// Full Mutable State ÃÂ· PDF Export ÃÂ· QB Integration Guide
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
const INIT_JOBS = [
  ...
  { id: "JOB-2026-002", name: "Midwest Tech STEM Lab Build-Out", customer: "C002", salesRep: "S001", phase: "In Progress", createdDate: "2026-02-03", startDate: "2026-02-10", endDate: "", dueDate: "2026-07-15", notes: "New STEM lab + library media center. Multi-vendor job Ã¢ÂÂ partial shipments expected.", paymentStatus: "partial", docStatuses: {}, activities: [] },
  ...
  { id: "JOB-2026-004", name: "Heritage Academy New Classroom Wing", customer: "C004", salesRep: "S003", phase: "Quoting", createdDate: "2026-03-05", startDate: "", endDate: "", dueDate: "2026-09-01", notes: "Brand new wing Ã¢ÂÂ 4 classrooms, 1 media room. Awaiting final budget approval from board.", paymentStatus: "unpaid", docStatuses: {}, activities: [] },
];

// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ ICONS Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
const I = ({ n, s = 18 }) => {
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ UTILS Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
const Badge = ({label,color}) => <span style={{display:"inline-flex",padding:"3px 8px",borderRadius:4,fontSize:10,fontWeight:500,letterSpacing:0.5,textTransform:"uppercase",background:`${color}0d`,color:`${color}bb`}}>{label}</span>;
const StatCard = ({label,value,sub,icon,color="#2dd4bf"}) => <Card style={{display:"flex",flexDirection:"column",gap:10}}><span style={{fontSize:11,color:"#525252",fontWeight:500,textTransform:"uppercase",letterSpacing:1.5}}>{label}</span><div style={{fontSize:28,fontWeight:600,color:"#e5e5e5",fontFamily:"'JetBrains Mono',monospace",letterSpacing:-0.5}}>{value}</div>{sub&&<div style={{fontSize:12,color:"#404040"}}>{sub}</div>}</Card>;
const Header = ({title,sub,action}) => <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end",marginBottom:20}}><div><h2 style={{fontSize:22,fontWeight:700,color:"#e5e5e5",marginBottom:4,letterSpacing:-0.5}}>{title}</h2>{sub&&<p style={{fontSize:13,color:"#525252"}}>{sub}</p>}</div>{action}</div>;
...
function usePrintOverlay() {
  const triggerPrint = (title, html) => {
    ...
    w.document.write('<!DOCTYPE html><html><head><meta charset="utf-8"><title>' + title + '</title><style>' +
      ...
      '</style></head><body>' +
      '<div class="btn-bar">' +
      '<button onclick="window.print()" style="background:#2dd4bf;color:#111">Save as PDF</button>' +
      '<button onclick="window.close()" style="background:#555;color:#fff">Close</button>' +
      '<span style="color:#999;font-size:12px;line-height:40px;margin-left:12px">Click Save as PDF Ã¢ÂÂ choose "Save as PDF" as the printer</span>' +
      '</div>' +
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
// MAIN APP Ã¢ÂÂ Supabase-backed with Auth
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ

// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ CONFIRM DIALOG Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function useConfirm() {
...
export default function MidwestAIOS() {
  ...
  const searchResults = searchQuery.length < 2 ? [] : [
    ...jobs.filter(j => j.name.toLowerCase().includes(searchQuery.toLowerCase()) || j.id.toLowerCase().includes(searchQuery.toLowerCase())).map(j => ({ type: "Job", name: j.name, sub: j.id + " ÃÂ· " + j.phase, id: j.id, action: () => { setSelectedJob(j.id); setPage("jobs"); setSearchOpen(false); } })),
    ...vendors.filter(v => v.name.toLowerCase().includes(searchQuery.toLowerCase())).map(v => ({ type: "Vendor", name: v.name, sub: v.category + " ÃÂ· " + (v.discountRate * 100).toFixed(0) + "% discount", id: v.id, action: () => { setPage("directory"); setSearchOpen(false); } })),
    ...
    ...reps.filter(r => r.name.toLowerCase().includes(searchQuery.toLowerCase()) && !r.id.includes("SEED_FLAG")).map(r => ({ type: "Rep", name: r.name, sub: r.territory + " ÃÂ· " + r.tier, id: r.id, action: () => { setPage("commissions"); setSearchOpen(false); } })),
    ...lineItems.filter(i => i.description.toLowerCase().includes(searchQuery.toLowerCase())).slice(0, 8).map(i => { const j = jobs.find(j => j.id === i.jobId); return { type: "Item", name: i.description, sub: (j?.name || "") + " ÃÂ· " + fmtN(i.qtyOrdered) + " units", id: i.id, action: () => { if (j) { setSelectedJob(j.id); setPage("jobs"); } setSearchOpen(false); } }; }),
  ].slice(0, 12);
  ...
  // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ LOAD FROM SUPABASE ON MOUNT Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
  useEffect(() => {
    const loadFromDb = async () => {
      try {
        ...
        if (hasData) {
          // Database has data Ã¢ÂÂ load it. Never overwrite.
          ...
          // Database is completely empty (first-time setup only) Ã¢ÂÂ seed with sample data
  ...
  // Save QB config to localStorage (not DB Ã¢ÂÂ contains secrets)
  useEffect(() => { try { localStorage.setItem('mw_qbConfig', JSON.stringify(qbConfig)); } catch {} }, [qbConfig]);

  // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ DERIVED COMPUTATIONS Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
  ...
  // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ MUTATORS (update state + save to Supabase) Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
  ...
  if (!appReady) return (
    <div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh",width:"100vw",background:"#0a0a0a",fontFamily:"'Satoshi',sans-serif"}}>
      <div style={{textAlign:"center"}}>
        ...
        <div style={{fontSize:12,color:"#525252",marginBottom:20}}>AI Operating System</div>
        ...
        <div style={{fontSize:11,color:"#404040",marginTop:16}}>Connecting to database...</div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{display:"flex",height:"100vh",width:"100vw",fontFamily:"'Satoshi','Satoshi',sans-serif",background:"#000000",color:"#d4d4d4",overflow:"hidden"}}>
      ...
      {/* Mobile hamburger */}
      {!mobileMenuOpen&&<button onClick={()=>setMobileMenuOpen(true)} className="mobile-menu-btn" style={{display:"none",position:"fixed",top:12,left:12,zIndex:10001,width:40,height:40,borderRadius:8,background:"#111111",border:"1px solid #222222",cursor:"pointer",alignItems:"center",justifyContent:"center",color:"#2dd4bf"}}><I n="dashboard" s={20}/></button>}
      ...
      <div className={"sidebar"+(mobileMenuOpen?" open":"")} style={{width:sidebarCollapsed?64:240,minWidth:sidebarCollapsed?64:240,background:"#0a0a0a",borderRight:"1px solid #1a1d27",display:"flex",flexDirection:"column",transition:"all 0.3s",overflow:"hidden"}}>
        <div style={{padding:"16px",borderBottom:"1px solid #1a1d27",display:"flex",alignItems:"center",gap:10}}>
          ...
          <div style={{flex:1,cursor:"pointer",minWidth:0}} onClick={()=>{if(window.innerWidth>768)setSidebarCollapsed(!sidebarCollapsed)}}><div style={{fontSize:13,fontWeight:700,color:"#5eead4",letterSpacing:0.3}}>Midwest Furnishings</div><div style={{fontSize:10,color:"#525252",letterSpacing:1.5,textTransform:"uppercase"}}>AI Operating System</div></div>
          <button className="mobile-close-btn" onClick={()=>setMobileMenuOpen(false)} style={{display:"none",width:28,height:28,borderRadius:6,background:"transparent",border:"1px solid #2a2d37",cursor:"pointer",alignItems:"center",justifyContent:"center",color:"#525252",flexShrink:0,padding:0}}><I n="close" s={14}/></button>
        </div>
        <nav style={{flex:1,padding:"12px 8px",display:"flex",flexDirection:"column",gap:2}}>
          {navItems.map(item=> <button key={item.id} onClick={()=>{setPage(item.id);setSelectedJob(null);setMobileMenuOpen(false)}} style={{display:"flex",alignItems:"center",gap:12,padding:sidebarCollapsed?"10px 12px":"10px 14px",borderRadius:8,border:"none",cursor:"pointer",background:page===item.id?"rgba(200,162,92,0.12)":"transparent",color:page===item.id?"#5eead4":"#737373",fontSize:13,fontWeight:page===item.id?600:400,fontFamily:"inherit",textAlign:"left",transition:"all 0.2s",justifyContent:sidebarCollapsed?"center":"flex-start"}} onMouseEnter={e=>{if(page!==item.id)e.currentTarget.style.background="rgba(255,255,255,0.04)"}} onMouseLeave={e=>{if(page!==item.id)e.currentTarget.style.background="transparent"}}><span style={{flexShrink:0,opacity:page===item.id?1:0.6}}><I n={item.icon} s={18}/></span>{!sidebarCollapsed&&<span style={{flex:1}}>{item.label}</span>}{!sidebarCollapsed&&item.badge&&<span style={{minWidth:18,height:18,borderRadius:9,background:item.badgeColor||"#2dd4bf",color:"#fff",fontSize:9,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 5px"}}>{item.badge}</span>}</button>)}
        </nav>
        {!sidebarCollapsed&&<div style={{padding:"12px 20px",borderTop:"1px solid #1a1d27",fontSize:10,color:"#404040"}}>
      ...
      <div style={{flex:1,overflow:"auto",background:"#000000"}}>
        <div className="main-content" style={{maxWidth:1400,margin:"0 auto",padding:"24px 32px"}}>
          ...
          {page==="dataimport"&&<div style={{animation:"fadeUp 0.3s"}}><div style={{marginBottom:24}}><h2 style={{fontSize:22,fontWeight:800,color:"#e5e5e5",margin:0}}>Data Import</h2><div style={{fontSize:13,color:"#525252",marginTop:4}}>Upload CSV or Excel exports to bulk-import historical data</div></div><CsvUploadPage {...ctx} db={db}/></div>}
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media(max-width:768px){
          ...
          .main-content{padding:20px 16px!important;padding-top:52px!important}
...
function Dashboard({jobs,lineItems,reps,vendors,customers,getJobFinancials,getJobItems,setPage,setSelectedJob,dateFilter,setDateFilter}){
  ...
  return <div style={{animation:"fadeUp 0.4s"}}><div style={{marginBottom:28}}><div style={{display:"flex",alignItems:"center",gap:12,marginBottom:8,flexWrap:"wrap"}}><h1 style={{fontSize:28,fontWeight:800,color:"#e5e5e5",letterSpacing:-1}}>Command Center</h1><div style={{padding:"4px 10px",background:"#34d399",borderRadius:20,fontSize:10,fontWeight:700,color:"#fff",letterSpacing:0.5}}>LIVE</div>
    <div style={{marginLeft:"auto",display:"flex",gap:4,background:"#111111",padding:3,borderRadius:8}}>{[["all","All Time"],["ytd","YTD"],["quarter","Quarter"],["month","Month"]].map(([v,l])=> <button key={v} onClick={()=>setDateFilter(v)} style={{padding:"5px 12px",borderRadius:6,border:"none",cursor:"pointer",background:dateFilter===v?"#2dd4bf":"transparent",color:dateFilter===v?"#000000":"#525252",fontSize:11,fontWeight:dateFilter===v?600:400,fontFamily:"inherit"}}>{l}</button>)}</div>
  ...
  const blob=new Blob([wb],{type:"text/csv"});const url=URL.createObjectURL(blob);const a=document.createElement("a");a.href=url;a.download="midwest-full-export-"+new Date().toISOString().split("T")[0]+".csv";a.click();URL.revokeObjectURL(url);notify("Full database exported Ã¢ÂÂ 5 tables")}}
  ].map((btn,i)=><button key={i} onClick={btn.fn} style={{display:"flex",alignItems:"center",gap:6,padding:"8px 14px",borderRadius:8,border:"1px solid #222222",background:"linear-gradient(135deg,#0a0a0a,#111111)",color:"#737373",fontSize:11,fontWeight:500,fontFamily:"inherit",cursor:"pointer",transition:"all 0.2s"}} onMouseEnter={e=>{e.currentTarget.style.borderColor="#2dd4bf44";e.currentTarget.style.color="#2dd4bf"}} onMouseLeave={e=>{e.currentTarget.style.borderColor="rgba(255,255,255,0.04)";e.currentTarget.style.color="#737373"}}><I n={btn.icon} s={12}/>{btn.label}</button>)}</div><p style={{fontSize:13,color:"#525252",marginBottom:4}}>Midwest Educational Furnishings Ã¢ÂÂ {dateFilter==="all"?"All time":dateFilter==="ytd"?"Year to date":dateFilter==="quarter"?"This quarter":"This month"} ÃÂ· {filtered.length} jobs</p></div>
    ...
    <div className="resp-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:24}}>
      <Card><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:16,display:"flex",alignItems:"center",gap:8}}><I n="alert" s={16}/> Action Required</div><div style={{display:"flex",flexDirection:"column",gap:10}}>
        {pendingInv>0&&<div style={{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",background:"#d9770610",border:"1px solid #d9770625",borderRadius:8,cursor:"pointer"}} onClick={()=>setPage("documents")}><div style={{width:8,height:8,borderRadius:"50%",background:"#fbbf24"}}/><span style={{fontSize:13,color:"#fbbf24",flex:1}}><strong>{pendingInv}</strong> line items received but not yet invoiced</span><Btn v="ghost" style={{fontSize:11,padding:"4px 10px"}} onClick={()=>setPage("documents")}>Draft Invoices &rarr;</Btn></div>}
        {pendingDel>0&&<div style={{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",background:"#2563eb10",border:"1px solid #2563eb25",borderRadius:8,cursor:"pointer"}} onClick={()=>setPage("deliveries")}><div style={{width:8,height:8,borderRadius:"50%",background:"#a78bfa"}}/><span style={{fontSize:13,color:"#c4b5fd",flex:1}}><strong>{pendingDel}</strong> line items awaiting delivery</span><Btn v="ghost" style={{fontSize:11,padding:"4px 10px"}} onClick={()=>setPage("deliveries")}>Track &rarr;</Btn></div>}
        <div style={{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",background:"#05966910",border:"1px solid #05966925",borderRadius:8,cursor:"pointer"}} onClick={()=>setPage("commissions")}><div style={{width:8,height:8,borderRadius:"50%",background:"#34d399"}}/><span style={{fontSize:13,color:"#6ee7b7",flex:1}}>Commission statements ready for review</span><Btn v="ghost" style={{fontSize:11,padding:"4px 10px"}} onClick={()=>setPage("commissions")}>Review &rarr;</Btn></div>
      ...
      <Card><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:16,display:"flex",alignItems:"center",gap:8}}><I n="briefcase" s={16}/> Active Jobs</div>{jobs.length===0&&<div style={{textAlign:"center",padding:20,color:"#525252",fontSize:13}}>No jobs yet. Go to Job Records to create your first project.</div>}<div style={{display:"flex",flexDirection:"column",gap:8}}>{jobs.map(job=>{const f=getJobFinancials(job.id);return <div key={job.id} onClick={()=>{setSelectedJob(job.id);setPage("jobs")}} className="slide-row hover-lift" style={{padding:"10px 12px",background:"#1a1a1a",borderRadius:8,cursor:"pointer",transition:"all 0.15s"}} onMouseEnter={e=>e.currentTarget.style.background="#222222"} onMouseLeave={e=>e.currentTarget.style.background="#1a1a1a"}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}><span style={{fontSize:13,fontWeight:600,color:"#d4d4d4"}}>{job.name}</span><Badge label={job.phase} color={statusColor(job.phase)}/></div><Bar value={f.totalReceived} max={f.totalOrdered||1} color={statusColor(job.phase)} height={4}/><div style={{display:"flex",justifyContent:"space-between",marginTop:4}}><span style={{fontSize:11,color:"#525252"}}>{fmtN(f.totalReceived)}/{fmtN(f.totalOrdered)} units</span><span style={{fontSize:11,color:"#525252"}}>{fmt(f.totalRevenue)}</span></div></div>})}</div></Card>
    </div>
    {/* Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ PIPELINE DONUT + REVENUE BREAKDOWN Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */}
    <div className="resp-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
      <Card><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:20}}>Pipeline by Phase</div>
        {(()=>{const phases=["Quoting","In Progress","Invoiced","Complete"];const data=phases.map(p=>{const pj=filtered.filter(j=>j.phase===p);return{phase:p,count:pj.length,rev:pj.reduce((s,j)=>s+getJobFinancials(j.id).totalRevenue,0)}});const total=data.reduce((s,d)=>s+d.rev,0)||1;const cx=100,cy=100,r=80,r2=60;let cumAngle=-Math.PI/2;return <div style={{display:"flex",alignItems:"center",gap:24}}><svg viewBox="0 0 200 200" style={{width:180,height:180,flexShrink:0}}>{data.map((d,i)=>{const angle=(d.rev/total)*Math.PI*2;const startAngle=cumAngle;cumAngle+=angle;const endAngle=cumAngle;const x1=cx+r*Math.cos(startAngle),y1=cy+r*Math.sin(startAngle);const x2=cx+r*Math.cos(endAngle),y2=cy+r*Math.sin(endAngle);const x3=cx+r2*Math.cos(endAngle),y3=cy+r2*Math.sin(endAngle);const x4=cx+r2*Math.cos(startAngle),y4=cy+r2*Math.sin(startAngle);const large=angle>Math.PI?1:0;if(d.rev===0)return null;return <path key={i} d={`M${x1},${y1} A${r},${r} 0 ${large},1 ${x2},${y2} L${x3},${y3} A${r2},${r2} 0 ${large},0 ${x4},${y4} Z`} fill={statusColor(d.phase)} opacity={0.85} style={{transition:"opacity 0.2s",cursor:"pointer"}} onMouseEnter={e=>e.currentTarget.style.opacity="1"} onMouseLeave={e=>e.currentTarget.style.opacity="0.85"}/>})}<text x={cx} y={cy-6} textAnchor="middle" fill="#e5e5e5" fontSize={20} fontWeight={700} fontFamily="JetBrains Mono">{fmt(total===1?0:total)}</text><text x={cx} y={cy+12} textAnchor="middle" fill="#525252" fontSize={9}>PIPELINE</text></svg><div style={{display:"flex",flexDirection:"column",gap:10}}>{data.map(d=><div key={d.phase} style={{display:"flex",alignItems:"center",gap:8}}><div style={{width:10,height:10,borderRadius:3,background:statusColor(d.phase),flexShrink:0}}/><div><div style={{fontSize:12,fontWeight:600,color:"#d4d4d4"}}>{d.phase}</div><div style={{fontSize:11,color:"#525252"}}>{d.count} job{d.count!==1?"s":""} ÃÂ· {fmt(d.rev)}</div></div></div>)}</div></div>})()}
      </Card>

      <Card><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:20}}>Revenue & Margin by Job</div>
        {(()=>{const data=filtered.map(j=>({name:j.name.length>18?j.name.slice(0,18)+"...":j.name,rev:getJobFinancials(j.id).totalRevenue,margin:getJobFinancials(j.id).margin}));const mx=Math.max(...data.map(d=>d.rev),1);return <div style={{display:"flex",flexDirection:"column",gap:6}}>{data.map((d,i)=><div key={i} style={{display:"flex",alignItems:"center",gap:10}}><span style={{fontSize:11,color:"#525252",width:120,flexShrink:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{d.name}</span><div style={{flex:1,position:"relative",height:24,background:"rgba(255,255,255,0.04)",borderRadius:6,overflow:"hidden"}}><div style={{position:"absolute",left:0,top:0,bottom:0,width:(d.rev/mx*100)+"%",background:"linear-gradient(90deg,#2dd4bf,#d4a843)",borderRadius:6,transition:"width 0.6s cubic-bezier(0.25,0.1,0.25,1)"}}/><span style={{position:"absolute",right:8,top:4,fontSize:10,fontWeight:600,color:"#fff",fontFamily:"'JetBrains Mono',monospace",zIndex:1}}>{fmt(d.rev)}</span></div><span style={{fontSize:11,fontWeight:600,color:d.margin>=30?"#34d399":d.margin>=20?"#fbbf24":"#f87171",width:44,textAlign:"right",flexShrink:0}}>{d.margin.toFixed(0)}%</span></div>)}</div>})()}
        <div style={{display:"flex",gap:16,marginTop:12,justifyContent:"center"}}><span style={{fontSize:10,color:"#2dd4bf",display:"flex",alignItems:"center",gap:4}}><span style={{width:12,height:6,background:"linear-gradient(90deg,#2dd4bf,#d4a843)",borderRadius:2,display:"inline-block"}}/> Revenue</span><span style={{fontSize:10,color:"#34d399",display:"flex",alignItems:"center",gap:4}}>Green = 30%+</span><span style={{fontSize:10,color:"#fbbf24",display:"flex",alignItems:"center",gap:4}}>Amber = 20-30%</span><span style={{fontSize:10,color:"#f87171",display:"flex",alignItems:"center",gap:4}}>Red = &lt;20%</span></div>
      </Card>
    </div>

    {/* Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ TEAM LEADERBOARD + TOP VENDORS Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */}
    <div className="resp-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginTop:16}}>
      <Card><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:16}}>Team Leaderboard</div>{[...reps].filter(r=>!r.id.includes("SEED_FLAG")).sort((a,b)=>{const ar=jobs.filter(j=>j.salesRep===a.id).reduce((s,j)=>s+getJobFinancials(j.id).totalRevenue,0);const br=jobs.filter(j=>j.salesRep===b.id).reduce((s,j)=>s+getJobFinancials(j.id).totalRevenue,0);return br-ar}).map((rep,idx)=>{const rj=jobs.filter(j=>j.salesRep===rep.id);const rv=rj.reduce((s,j)=>s+getJobFinancials(j.id).totalRevenue,0);return <div key={rep.id} className="slide-row" style={{display:"flex",alignItems:"center",gap:12,padding:"12px 0",borderBottom:"1px solid #1e213008"}}><div style={{width:28,height:28,borderRadius:8,background:idx===0?"#2dd4bf20":idx===1?"#9ca3af20":"#63636620",display:"flex",alignItems:"center",justifyContent:"center",fontSize:12,fontWeight:700,color:idx===0?"#2dd4bf":idx===1?"#737373":"#333333"}}>{idx+1}</div><div style={{flex:1}}><div style={{fontSize:13,fontWeight:600,color:"#d4d4d4"}}>{rep.name}</div><div style={{fontSize:11,color:"#525252"}}>{rep.territory} ÃÂ· {rj.length} jobs ÃÂ· {pct(rep.commissionRate*100)}</div></div><div style={{textAlign:"right"}}><div style={{fontSize:14,fontWeight:700,color:"#2dd4bf",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(rv)}</div><div style={{fontSize:10,color:"#34d399"}}>comm: {fmt(rv*rep.commissionRate)}</div></div></div>})}</Card>
      <Card><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:16}}>Top Vendors by Spend</div>{(()=>{const vt={};lineItems.forEach(i=>{const v=vendors.find(v=>v.id===i.vendor);if(v)vt[v.name]=(vt[v.name]||0)+i.unitCost*i.qtyOrdered});const sorted=Object.entries(vt).sort((a,b)=>b[1]-a[1]).slice(0,8);const mx=sorted[0]?.[1]||1;return sorted.map(([name,total],i)=><div key={name} style={{display:"flex",alignItems:"center",gap:12,padding:"8px 0",borderBottom:"1px solid rgba(255,255,255,0.04)"}}><div style={{width:28,height:28,borderRadius:8,background:"#2563eb18",display:"flex",alignItems:"center",justifyContent:"center",fontSize:10,fontWeight:700,color:"#a78bfa"}}>{i+1}</div><div style={{flex:1}}><div style={{fontSize:12,color:"#d4d4d4",marginBottom:4}}>{name}</div><Bar value={total} max={mx} color="#a78bfa" height={4}/></div><span style={{fontSize:12,fontWeight:600,color:"#a78bfa",fontFamily:"'JetBrains Mono',monospace",flexShrink:0}}>{fmt(total)}</span></div>)})()}</Card>
    </div>
  </div>;
}

// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
// JOB RECORDS Ã¢ÂÂ Full CRUD + Line Items
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function JobsPage(ctx){
  ...
  return <div style={{animation:"fadeUp 0.4s"}}>
    <Header title="Job Records" sub="Central hub Ã¢ÂÂ single source of truth for every project" action={<div style={{display:"flex",gap:8}}><Btn onClick={()=>setNewCust(true)} v="secondary"><I n="plus" s={14}/> New Customer</Btn><Btn onClick={()=>setShowNewJob(true)}><I n="plus" s={14}/> New Job</Btn></div>}/>
    ...
    <div style={{display:"flex",gap:12,marginBottom:16,alignItems:"center",flexWrap:"wrap"}}>
      ...
      <div style={{display:"flex",gap:4,background:"#111111",padding:3,borderRadius:8}}>
        {[["table","Table"],["kanban","Kanban"]].map(([v,l])=><button key={v} onClick={()=>setViewMode(v)} style={{padding:"5px 12px",borderRadius:6,border:"none",cursor:"pointer",background:viewMode===v?"#2dd4bf":"transparent",color:viewMode===v?"#000000":"#525252",fontSize:11,fontWeight:viewMode===v?600:400,fontFamily:"inherit"}}>{l}</button>)}
      </div>
      <div style={{display:"flex",gap:4,background:"#111111",padding:3,borderRadius:8,marginLeft:"auto"}}>
        <span style={{fontSize:11,color:"#525252",padding:"5px 8px"}}>Sort:</span>
        {[["createdDate","Date"],["name","Name"],["revenue","Revenue"],["margin","Margin"]].map(([v,l])=><button key={v} onClick={()=>setSortBy(v)} style={{padding:"5px 10px",borderRadius:6,border:"none",cursor:"pointer",background:sortBy===v?"#2dd4bf22":"transparent",color:sortBy===v?"#2dd4bf":"#525252",fontSize:11,fontFamily:"inherit"}}>{l}</button>)}
      </div>
    </div>

    {newCust&&<Card style={{marginBottom:20,border:"1px solid #2563eb30"}}><div style={{fontSize:14,fontWeight:700,marginBottom:16,color:"#a78bfa"}}>Add New Customer</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:12,marginBottom:12}}>{[["name","Name"],["contact","Contact"],["email","Email"],["phone","Phone"]].map(([k,l])=><div key={k}><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>{l}</label><input value={custForm[k]} onChange={e=>setCustForm({...custForm,[k]:e.target.value})} style={inputStyle}/></div>)}</div><div style={{display:"flex",gap:8}}><Btn onClick={()=>{if(custForm.name){addCustomer(custForm);setNewCust(false);setCustForm({name:"",contact:"",email:"",phone:"",type:"K-12 District"});notify("Customer added")}}}>Add Customer</Btn><Btn v="secondary" onClick={()=>setNewCust(false)}>Cancel</Btn></div></Card>}

    {showNewJob&&<Card style={{marginBottom:20,border:"1px solid #2dd4bf30"}}><div style={{fontSize:14,fontWeight:700,marginBottom:16,color:"#2dd4bf"}}>Create New Job Record</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12,marginBottom:12}}><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Job Name</label><input value={newJob.name} onChange={e=>setNewJob({...newJob,name:e.target.value})} placeholder="e.g., Lincoln USD Media Center" style={inputStyle}/></div><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Customer</label><select value={newJob.customer} onChange={e=>setNewJob({...newJob,customer:e.target.value})} style={inputStyle}>{customers.map(c=><option key={c.id} value={c.id}>{c.name}</option>)}</select></div><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Sales Rep</label><select value={newJob.salesRep} onChange={e=>setNewJob({...newJob,salesRep:e.target.value})} style={inputStyle}>{reps.map(r=><option key={r.id} value={r.id}>{r.name}</option>)}</select></div></div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:12,marginBottom:12}}><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Start Date</label><input type="date" value={newJob.startDate} onChange={e=>setNewJob({...newJob,startDate:e.target.value})} style={inputStyle}/></div><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Due Date</label><input type="date" value={newJob.dueDate} onChange={e=>setNewJob({...newJob,dueDate:e.target.value})} style={inputStyle}/></div><div style={{gridColumn:"span 2"}}><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Notes</label><input value={newJob.notes} onChange={e=>setNewJob({...newJob,notes:e.target.value})} placeholder="Project details..." style={inputStyle}/></div></div><div style={{display:"flex",gap:8}}><Btn onClick={handleCreateJob}>Create Job Record</Btn><Btn v="secondary" onClick={()=>setShowNewJob(false)}>Cancel</Btn></div></Card>}
    ...
    {viewMode==="table"&&<Tbl columns={[
      ...
      {header:"Created",render:r=><span style={{fontSize:11,color:"#525252"}}>{r.createdDate||"Ã¢ÂÂ"}</span>},
      {header:"Start",render:r=><span style={{fontSize:11,color:r.startDate?"#a3a3a3":"#404040"}}>{r.startDate||"Ã¢ÂÂ"}</span>},
      {header:"Due",render:r=><span style={{fontSize:11,color:r.dueDate&&new Date(r.dueDate)<new Date()?"#f87171":"#a3a3a3"}}>{r.dueDate||"Ã¢ÂÂ"}</span>},
    ...
    ]} data={sortedJobs} onRowClick={r=>setSelectedJob(r.id)}/>}{sortedJobs.length===0&&<Card style={{textAlign:"center",padding:40,marginTop:16}}><div style={{fontSize:40,marginBottom:8}}>+</div><div style={{fontSize:16,fontWeight:600,color:"#2dd4bf",marginBottom:4}}>No jobs yet</div><div style={{fontSize:13,color:"#525252",marginBottom:16}}>Create your first job to start tracking projects, deliveries, and invoices.</div><Btn onClick={()=>setShowNewJob(true)}><I n="plus" s={14}/> Create First Job</Btn></Card>}
    ...
    {viewMode==="kanban"&&<div className="kanban-grid" style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:12,minHeight:400}}>
      {["Quoting","In Progress","Invoiced","Complete"].map(phase=><div key={phase} onDrop={e=>handleDrop(e,phase)} onDragOver={handleDragOver} style={{background:"#111111",borderRadius:12,padding:12,border:"1px solid #222222",minHeight:300}}>
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12,paddingBottom:8,borderBottom:"2px solid "+statusColor(phase)}}><div style={{width:8,height:8,borderRadius:"50%",background:statusColor(phase)}}/><span style={{fontSize:13,fontWeight:700,color:"#e5e5e5"}}>{phase}</span><span style={{fontSize:11,color:"#525252",marginLeft:"auto"}}>{sortedJobs.filter(j=>j.phase===phase).length}</span></div>
        <div style={{display:"flex",flexDirection:"column",gap:8}}>
          {sortedJobs.filter(j=>j.phase===phase).map(job=>{const f=getJobFinancials(job.id);return <div key={job.id} draggable onDragStart={e=>handleDragStart(e,job.id)} onClick={()=>setSelectedJob(job.id)} style={{background:"#1a1a1a",borderRadius:8,padding:12,cursor:"grab",border:"1px solid #2a2d37",transition:"all 0.15s"}} onMouseEnter={e=>{e.currentTarget.style.borderColor="#2dd4bf44";e.currentTarget.style.transform="translateY(-1px)"}} onMouseLeave={e=>{e.currentTarget.style.borderColor="#333333";e.currentTarget.style.transform="translateY(0)"}}>
            ...
            <div style={{fontSize:11,color:"#525252",marginBottom:6}}>{customers.find(c=>c.id===job.customer)?.name}</div>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
              ...
              <span style={{fontSize:10,color:f.margin>=30?"#34d399":"#fbbf24"}}>{pct(f.margin)}</span>
            </div>
            <Bar value={f.totalReceived} max={f.totalOrdered||1} color={statusColor(phase)} height={3}/>
            <div style={{display:"flex",justifyContent:"space-between",marginTop:4}}><span style={{fontSize:10,color:"#404040"}}>{job.startDate||job.createdDate}</span><span style={{fontSize:10,color:job.dueDate&&new Date(job.dueDate)<new Date()?"#f87171":"#404040"}}>Due: {job.dueDate||"TBD"}</span></div>
          </div>})}
        </div>
      </div>)}
    </div>}
...
function JobDetail({job,ctx}){
  const {getJobFinancials,getJobItems,getItemStatus,vendors,customers,reps,updateJob,addJob,addLineItem,updateLineItem,deleteLineItem,deleteJob,setSelectedJob,notify,lineItems,jobs}=ctx;
  ...
  const duplicateJob=()=>{const newId='JOB-'+new Date().getFullYear()+'-'+String(Math.floor(Math.random()*900)+100);const newJob={...job,id:newId,name:job.name+' (Copy)',phase:'Quoting',paymentStatus:'unpaid',createdDate:new Date().toISOString().split('T')[0],startDate:'',endDate:''};addJob(newJob);items.forEach(item=>{addLineItem({...item,id:'LI-'+Math.random().toString(36).slice(2,8),jobId:newId,qtyReceived:0,qtyInvoiced:0,deliveryDate:'',invoiceDate:''})});setSelectedJob(newId);notify('Job duplicated Ã¢ÂÂ '+newId+' created with all line items')};

  const saveJob=()=>{updateJob(job.id,editJob);setEditing(false);notify("Job updated Ã¢ÂÂ changes propagated everywhere")};
  ...
  const saveNewItem=()=>{if(!newItem.description)return;addLineItem({...newItem,jobId:job.id,listPrice:parseFloat(newItem.listPrice)||0,unitCost:parseFloat(newItem.unitCost)||0,unitPrice:parseFloat(newItem.unitPrice)||0,qtyOrdered:parseInt(newItem.qtyOrdered)||0,qtyReceived:parseInt(newItem.qtyReceived)||0,qtyInvoiced:parseInt(newItem.qtyInvoiced)||0});setAddingItem(false);setNewItem({description:"",vendor:vendors[0]?.id||"",listPrice:0,unitCost:0,unitPrice:0,qtyOrdered:0,qtyReceived:0,qtyInvoiced:0});notify("Line item added Ã¢ÂÂ financials updated")};
  ...
  return <div style={{animation:"fadeUp 0.3s"}}>
    <div style={{position:"sticky",top:0,zIndex:100,background:"rgba(0,0,0,0.92)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",margin:"-32px -40px 0",padding:"16px 40px 0",borderBottom:"1px solid rgba(255,255,255,0.04)"}}>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12,flexWrap:"wrap",gap:8}}>
        <div><div style={{display:"flex",alignItems:"center",gap:10,marginBottom:2}}><h2 style={{fontSize:22,fontWeight:800,color:"#e5e5e5",margin:0}}>{job.name}</h2><Badge label={job.phase} color={statusColor(job.phase)}/><Badge label={job.paymentStatus} color={statusColor(job.paymentStatus)}/></div><div style={{fontSize:12,color:"#525252"}}>{job.id} ÃÂ· {customer?.name} ÃÂ· {rep?.name} ÃÂ· {fmt(f.totalRevenue)} rev ÃÂ· {pct(f.margin)} margin</div></div>
        <div style={{display:"flex",gap:6,flexWrap:"wrap"}}><Btn v="danger" onClick={()=>deleteJob(job.id)} style={{fontSize:11,padding:"6px 10px"}}><I n="close" s={12}/> Delete</Btn><Btn v="secondary" onClick={()=>setEditing(!editing)} style={{fontSize:11,padding:"6px 10px"}}><I n="edit" s={12}/> Edit</Btn><Btn v="secondary" onClick={duplicateJob} style={{fontSize:11,padding:"6px 10px"}}><I n="package" s={12}/> Duplicate</Btn><Btn onClick={()=>setAddingItem(true)} style={{fontSize:11,padding:"6px 10px"}}><I n="plus" s={12}/> Add Item</Btn><Btn v="ghost" onClick={()=>{
  ...
  const invTotal=allItems.reduce((s,i)=>s+i.unitPrice*i.qtyOrdered,0);const costTotal=allItems.reduce((s,i)=>s+i.unitCost*i.qtyOrdered,0);
  const coverHtml='<div style="text-align:center;padding:120px 0 60px"><img src="'+MW_LOGO+'" style="height:60px;margin-bottom:24px"/><div style="font-size:28px;font-weight:800;margin-bottom:8px">'+job.name+'</div><div style="font-size:16px;color:#666;margin-bottom:4px">'+(customer2?.name||'')+'</div><div style="font-size:14px;color:#999;margin-bottom:40px">Prepared by Midwest Educational Furnishings</div><div style="font-size:12px;color:#999">'+(new Date().toLocaleDateString())+'</div></div>';
  const quoteRows=allItems.map(i=>'<tr><td>'+i.description+'</td><td style="text-align:right">'+i.qtyOrdered+'</td><td style="text-align:right">$'+i.unitPrice.toFixed(2)+'</td><td style="text-align:right"><strong>$'+(i.unitPrice*i.qtyOrdered).toFixed(2)+'</strong></td></tr>').join('');
  const quoteHtml='<h2 style="color:#2dd4bf;border-bottom:2px solid #2dd4bf;padding-bottom:8px">PROJECT QUOTE</h2><table><thead><tr><th>Item</th><th style="text-align:right">Qty</th><th style="text-align:right">Price</th><th style="text-align:right">Total</th></tr></thead><tbody>'+quoteRows+'</tbody><tfoot><tr class="total-row"><td colspan="3" style="text-align:right;padding:10px 8px">TOTAL</td><td style="text-align:right;padding:10px 8px">$'+invTotal.toFixed(2)+'</td></tr></tfoot></table>';
  const poSections=jobPOs.map(po=>'<h3 style="color:#2563eb;margin-top:24px">PO Ã¢ÂÂ '+(po.vendor?.name||'')+'</h3><table><thead><tr><th>Item</th><th style="text-align:right">Qty</th><th style="text-align:right">Cost</th><th style="text-align:right">Total</th></tr></thead><tbody>'+po.items.map(i=>'<tr><td>'+i.description+'</td><td style="text-align:right">'+i.qtyOrdered+'</td><td style="text-align:right">$'+i.unitCost.toFixed(2)+'</td><td style="text-align:right">$'+(i.unitCost*i.qtyOrdered).toFixed(2)+'</td></tr>').join('')+'</tbody></table>').join('');
  const deliveryRows=allItems.map(i=>'<tr><td>'+i.description+'</td><td style="text-align:right">'+i.qtyOrdered+'</td><td style="text-align:right">'+i.qtyReceived+'</td><td style="text-align:right">'+(i.qtyOrdered-i.qtyReceived)+'</td><td style="text-align:center">'+(i.qtyReceived>=i.qtyOrdered?'Complete':'Pending')+'</td></tr>').join('');
  const deliveryHtml='<h2 style="color:#d97706;border-bottom:2px solid #d97706;padding-bottom:8px;margin-top:32px">DELIVERY STATUS</h2><table><thead><tr><th>Item</th><th style="text-align:right">Ordered</th><th style="text-align:right">Received</th><th style="text-align:right">Outstanding</th><th style="text-align:center">Status</th></tr></thead><tbody>'+deliveryRows+'</tbody></table>';
  const summaryHtml='<h2 style="color:#059669;border-bottom:2px solid #059669;padding-bottom:8px;margin-top:32px">FINANCIAL SUMMARY</h2><table><tbody><tr><td>Total Revenue</td><td style="text-align:right"><strong>$'+invTotal.toFixed(2)+'</strong></td></tr><tr><td>Total Cost</td><td style="text-align:right">$'+costTotal.toFixed(2)+'</td></tr><tr><td>Gross Profit</td><td style="text-align:right;color:#059669"><strong>$'+(invTotal-costTotal).toFixed(2)+'</strong></td></tr><tr><td>Margin</td><td style="text-align:right">'+(invTotal>0?((1-costTotal/invTotal)*100).toFixed(1):0)+'%</td></tr></tbody></table>';
  const sigHtml='<div style="margin-top:48px;border-top:1px solid #ddd;padding-top:24px"><h3>Approval</h3><div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;margin-top:20px"><div><div style="border-bottom:1px solid #333;height:40px"></div><div style="font-size:11px;color:#999;margin-top:4px">Authorized Signature</div></div><div><div style="border-bottom:1px solid #333;height:40px"></div><div style="font-size:11px;color:#999;margin-top:4px">Date</div></div></div></div>';
  triggerPrint('Job Packet - '+job.name,coverHtml+'<div style="page-break-before:always"></div>'+quoteHtml+'<div style="page-break-before:always"></div><h2 style="color:#2563eb;border-bottom:2px solid #2563eb;padding-bottom:8px">PURCHASE ORDERS</h2>'+poSections+'<div style="page-break-before:always"></div>'+deliveryHtml+summaryHtml+sigHtml)}} style={{fontSize:11,padding:"6px 10px"}}><I n="download" s={12}/> Job Packet</Btn></div>
      </div>
    </div>
    <div style={{paddingTop:20}}>

    {editing&&<Card style={{marginBottom:20,border:"1px solid #2dd4bf30"}}><div style={{fontSize:14,fontWeight:700,marginBottom:12,color:"#2dd4bf"}}>Edit Job Record</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12,marginBottom:12}}><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Job Name</label><input value={editJob.name} onChange={e=>setEditJob({...editJob,name:e.target.value})} style={inputStyle}/></div><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Phase</label><select value={editJob.phase} onChange={e=>setEditJob({...editJob,phase:e.target.value})} style={inputStyle}>{["Quoting","In Progress","Invoiced","Complete"].map(p=><option key={p}>{p}</option>)}</select></div><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Payment Status</label><select value={editJob.paymentStatus} onChange={e=>setEditJob({...editJob,paymentStatus:e.target.value})} style={inputStyle}>{["unpaid","partial","paid"].map(p=><option key={p}>{p}</option>)}</select></div></div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12,marginBottom:12}}><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Customer</label><select value={editJob.customer} onChange={e=>setEditJob({...editJob,customer:e.target.value})} style={inputStyle}>{customers.map(c=><option key={c.id} value={c.id}>{c.name}</option>)}</select></div><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Sales Rep</label><select value={editJob.salesRep} onChange={e=>setEditJob({...editJob,salesRep:e.target.value})} style={inputStyle}>{reps.map(r=><option key={r.id} value={r.id}>{r.name}</option>)}</select></div><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Due Date</label><input type="date" value={editJob.dueDate} onChange={e=>setEditJob({...editJob,dueDate:e.target.value})} style={inputStyle}/></div></div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:12,marginBottom:12}}><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Start Date</label><input type="date" value={editJob.startDate||""} onChange={e=>setEditJob({...editJob,startDate:e.target.value})} style={inputStyle}/></div><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>End Date</label><input type="date" value={editJob.endDate||""} onChange={e=>setEditJob({...editJob,endDate:e.target.value})} style={inputStyle}/></div><div style={{gridColumn:"span 2"}}><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Notes</label><textarea value={editJob.notes} onChange={e=>setEditJob({...editJob,notes:e.target.value})} rows={3} style={{...inputStyle,resize:"vertical",minHeight:60}}/></div></div><div style={{display:"flex",gap:8}}><Btn onClick={saveJob}>Save Changes</Btn><Btn v="secondary" onClick={()=>setEditing(false)}>Cancel</Btn></div></Card>}

    {/* DETAILS */}<><div className="resp-grid-5" style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:12,marginBottom:24}}>
      <Card style={{padding:14,textAlign:"center"}}><div style={{fontSize:11,color:"#525252",marginBottom:4}}>Revenue</div><div style={{fontSize:18,fontWeight:700,fontFamily:"'JetBrains Mono',monospace",color:"#e5e5e5"}}>{fmt(f.totalRevenue)}</div></Card>
      <Card style={{padding:14,textAlign:"center"}}><div style={{fontSize:11,color:"#525252",marginBottom:4}}>Cost</div><div style={{fontSize:18,fontWeight:700,fontFamily:"'JetBrains Mono',monospace",color:"#e5e5e5"}}>{fmt(f.totalCost)}</div></Card>
      <Card style={{padding:14,textAlign:"center"}}><div style={{fontSize:11,color:"#525252",marginBottom:4}}>Margin</div><div style={{fontSize:18,fontWeight:700,fontFamily:"'JetBrains Mono',monospace",color:"#34d399"}}>{pct(f.margin)}</div></Card>
      <Card style={{padding:14,textAlign:"center"}}><div style={{fontSize:11,color:"#525252",marginBottom:4}}>Line Items</div><div style={{fontSize:18,fontWeight:700,fontFamily:"'JetBrains Mono',monospace",color:"#e5e5e5"}}>{f.itemCount}</div></Card>
      <Card style={{padding:14,textAlign:"center"}}><div style={{fontSize:11,color:"#525252",marginBottom:4}}>Commission</div><div style={{fontSize:18,fontWeight:700,fontFamily:"'JetBrains Mono',monospace",color:"#2dd4bf"}}>{fmt(f.totalRevenue*(rep?.commissionRate||0))}</div></Card>
    </div>
    <div className="resp-grid-4" style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:12,marginBottom:24}}>
      <Card style={{padding:12}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><span style={{fontSize:11,color:"#525252"}}>Payment</span><Badge label={job.paymentStatus} color={statusColor(job.paymentStatus)}/></div></Card>
      <Card style={{padding:12}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><span style={{fontSize:11,color:"#525252"}}>Delivery</span><span style={{fontSize:12,fontWeight:600,color:f.totalReceived===f.totalOrdered?"#34d399":f.totalReceived>0?"#fbbf24":"#525252"}}>{fmtN(f.totalReceived)}/{fmtN(f.totalOrdered)}</span></div><Bar value={f.totalReceived} max={f.totalOrdered||1} color={f.totalReceived===f.totalOrdered?"#34d399":"#fbbf24"} height={3}/></Card>
      <Card style={{padding:12}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><span style={{fontSize:11,color:"#525252"}}>Invoiced</span><span style={{fontSize:12,fontWeight:600,color:items.every(i=>i.qtyInvoiced>=i.qtyOrdered)?"#34d399":"#2dd4bf"}}>{fmt(items.reduce((s,i)=>s+i.unitPrice*i.qtyInvoiced,0))}</span></div><Bar value={items.reduce((s,i)=>s+i.qtyInvoiced,0)} max={items.reduce((s,i)=>s+i.qtyOrdered,0)||1} color="#2dd4bf" height={3}/></Card>
      <Card style={{padding:12}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><span style={{fontSize:11,color:"#525252"}}>Due Date</span><span style={{fontSize:12,fontWeight:600,color:job.dueDate&&new Date(job.dueDate)<new Date()&&job.paymentStatus!=="paid"?"#f87171":"#a3a3a3"}}>{job.dueDate||"Not set"}</span></div>{job.dueDate&&new Date(job.dueDate)<new Date()&&job.paymentStatus!=="paid"&&<span style={{fontSize:10,color:"#f87171"}}>OVERDUE</span>}</Card>
    </div>
    ...
    <div style={{overflowX:"auto",WebkitOverflowScrolling:"touch",borderRadius:10,border:"1px solid #222222"}}><table style={{width:"100%",borderCollapse:"collapse",fontSize:12,minWidth:800}}><thead><tr style={{background:"#111111"}}>{["Item","Vendor","Unit Cost","Unit Price","Ordered","Received","Invoiced","Status","Line Total",""].map((h,i)=><th key={i} style={{padding:"8px 10px",textAlign:"left",fontWeight:600,color:"#525252",fontSize:10,textTransform:"uppercase",letterSpacing:0.8,borderBottom:"1px solid #222222",whiteSpace:"nowrap"}}>{h}</th>)}</tr></thead><tbody>{items.map(item=>{
      ...
      return <tr key={item.id} style={{borderBottom:"1px solid #1a1d2708"}}>
        <td style={{padding:"8px 10px",color:"#e5e5e5",fontWeight:500,minWidth:180,maxWidth:240}}>{isEditing?<input value={item.description} onChange={e=>updateLineItem(item.id,{description:e.target.value})} style={{...inputStyle,fontSize:12,padding:"4px 8px"}}/>:item.description}</td>
        <td style={{padding:"8px 10px",color:"#a3a3a3",minWidth:120}}>{isEditing?<select value={item.vendor} onChange={e=>updateLineItem(item.id,{vendor:e.target.value})} style={{...inputStyle,fontSize:12,padding:"4px 8px"}}>{vendors.map(v=><option key={v.id} value={v.id}>{v.name}{v.discountRate?' ('+((v.discountRate*100).toFixed(0))+'% off)':''}</option>)}</select>:<span>{vendors.find(v=>v.id===item.vendor)?.name}{(()=>{const v=vendors.find(v=>v.id===item.vendor);return v?.discountRate?<span style={{fontSize:10,color:"#34d399",marginLeft:4}}>({(v.discountRate*100).toFixed(0)}% disc)</span>:null})()}</span>}</td>
        <td style={{padding:"8px 10px"}}>{isEditing?<input type="number" value={item.unitCost} onChange={e=>updateLineItem(item.id,{unitCost:parseFloat(e.target.value)||0})} style={{...inputStyle,fontSize:12,padding:"4px 8px",width:80}}/>:<span style={{fontFamily:"'JetBrains Mono',monospace"}}>{fmt(item.unitCost)}</span>}</td>
        <td style={{padding:"8px 10px"}}>{isEditing?<input type="number" value={item.unitPrice} onChange={e=>updateLineItem(item.id,{unitPrice:parseFloat(e.target.value)||0})} style={{...inputStyle,fontSize:12,padding:"4px 8px",width:80}}/>:<span style={{fontFamily:"'JetBrains Mono',monospace"}}>{fmt(item.unitPrice)}</span>}</td>
        ...
        <td style={{padding:"8px 10px"}}><span style={{fontFamily:"'JetBrains Mono',monospace",fontWeight:600}}>{fmt(item.unitPrice*item.qtyOrdered)}</span></td>
    ...
    <Card style={{marginTop:24}}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:0,overflow:"auto",padding:"8px 0"}}>
        {[
          {label:"Created",date:job.createdDate,done:!!job.createdDate,color:"#525252"},
          ...
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:4}}>
            ...
            <div style={{fontSize:10,fontWeight:600,color:step.done?step.color:"#404040",textAlign:"center"}}>{step.label}</div>
            {step.date&&<div style={{fontSize:9,color:"#525252"}}>{step.date}</div>}
          </div>
...
function DeliveryCalendar({jobs,lineItems,vendors,customers,getJobItems,setPage,setSelectedJob,notify}){
  ...
  return <div style={{animation:"fadeUp 0.4s"}}><Header title="Delivery Calendar" sub={monthName+" "+year+" Ã¢ÂÂ expected deliveries for active jobs"} action={<div style={{display:"flex",gap:8}}><Btn v="secondary" onClick={()=>setMonthOffset(p=>p-1)}>&larr; Prev</Btn><Btn v="secondary" onClick={()=>setMonthOffset(0)}>Today</Btn><Btn v="secondary" onClick={()=>setMonthOffset(p=>p+1)}>Next &rarr;</Btn></div>}/>
    <div style={{display:"grid",gridTemplateColumns:"repeat(7,1fr)",gap:1,background:"#222222",borderRadius:12,overflow:"hidden",border:"1px solid #222222"}}>
      {["Sun","Mon","Tue","Wed","Thu","Fri","Sat"].map(d=><div key={d} style={{padding:"10px 8px",textAlign:"center",fontSize:11,fontWeight:600,color:"#525252",background:"#111111"}}>{d}</div>)}
      {days.map((day,i)=>{
        ...
        return <div key={i} style={{minHeight:90,padding:6,background:day?"#000000":"#0a0a0a",borderTop:"1px solid #222222",position:"relative"}}>
          ...
          {dayEvents.slice(0,3).map((ev,ei)=><div key={ei} onClick={()=>{if(ev.jobId){setSelectedJob(ev.jobId);setPage("jobs")}}} style={{fontSize:9,padding:"2px 4px",marginBottom:2,borderRadius:4,background:ev.color+"18",color:ev.color,cursor:"pointer",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",borderLeft:"2px solid "+ev.color}}>{ev.vendor}: {ev.qty} {ev.item.slice(0,20)}</div>)}
          {dayEvents.length>3&&<div style={{fontSize:9,color:"#525252"}}>+{dayEvents.length-3} more</div>}
        </div>
      })}
    </div>
    {events.length===0&&<Card style={{marginTop:16,textAlign:"center",padding:30}}><div style={{fontSize:14,color:"#525252"}}>No deliveries scheduled for {monthName} {year}. Set delivery dates on line items or due dates on jobs to see them here.</div></Card>}
    {events.length>0&&<Card style={{marginTop:16}}><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:12}}>{monthName} Deliveries ({events.length} items)</div>{events.sort((a,b)=>a.day-b.day).map((ev,i)=><div key={i} className="slide-row" onClick={()=>{if(ev.jobId){setSelectedJob(ev.jobId);setPage("jobs")}}} style={{display:"flex",alignItems:"center",gap:12,padding:"8px 0",borderBottom:"1px solid #222222",cursor:"pointer"}}><div style={{width:32,textAlign:"center",fontSize:14,fontWeight:700,color:"#2dd4bf"}}>{ev.day}</div><div style={{width:4,height:24,borderRadius:2,background:ev.color}}/><div style={{flex:1}}><div style={{fontSize:12,fontWeight:600,color:"#d4d4d4"}}>{ev.vendor} Ã¢ÂÂ {ev.item.slice(0,40)}</div><div style={{fontSize:11,color:"#525252"}}>{ev.job} ÃÂ· {ev.qty} units pending</div></div></div>)}</Card>}
  </div>;
}

// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
// DELIVERY TRACKER Ã¢ÂÂ Real updates to state
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function DeliveryPage({jobs,lineItems,vendors,customers,getItemStatus,getJobItems,updateLineItem,setPage,setSelectedJob,notify}){
  ...
  return <div style={{animation:"fadeUp 0.4s"}}><Header title="Deliveries" sub="Track shipments and plan receiving"/>
    ...
    {receiveModal&&<Card style={{marginBottom:20,border:"1px solid #d9770644"}}><div style={{fontSize:14,fontWeight:700,marginBottom:12,color:"#fbbf24"}}>Log Shipment Received</div><div style={{fontSize:13,color:"#a3a3a3",marginBottom:4}}>{receiveModal.description}</div><div style={{fontSize:12,color:"#525252",marginBottom:12}}>Outstanding: {fmtN(receiveModal.qtyOrdered-receiveModal.qtyReceived)} units ÃÂ· Already received: {fmtN(receiveModal.qtyReceived)}</div><div style={{display:"flex",gap:8,alignItems:"center"}}><input type="number" value={receiveQty} onChange={e=>setReceiveQty(e.target.value)} placeholder="Qty received" min="1" max={receiveModal.qtyOrdered-receiveModal.qtyReceived} style={{...inputStyle,width:120}}/><Btn onClick={handleReceive}>Log Receipt</Btn><Btn v="secondary" onClick={()=>{setReceiveModal(null);setReceiveQty("")}}>Cancel</Btn></div></Card>}

    {groupedJobs.length===0&&<Card style={{textAlign:"center",padding:40}}><div style={{fontSize:16,color:"#34d399",fontWeight:600,marginBottom:4}}>All deliveries complete</div><div style={{fontSize:13,color:"#525252"}}>No outstanding items across any job.</div></Card>}
      ...
      return <Card key={job.id} style={{marginBottom:16}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
          <div>
            ...
            <div style={{fontSize:12,color:"#525252",marginTop:2}}>{job.id} ÃÂ· {items.length} items pending ÃÂ· {fmtN(totalOut)} units outstanding</div>
          </div>
          <div style={{display:"flex",gap:8,alignItems:"center"}}>
            <div style={{textAlign:"right",marginRight:8}}><div style={{fontSize:11,color:"#525252"}}>Received</div><div style={{fontSize:14,fontWeight:600,color:"#fbbf24",fontFamily:"'JetBrains Mono',monospace"}}>{fmtN(totalRcv)}/{fmtN(totalOrd)}</div></div>
        ...
        <div style={{overflowX:"auto",marginTop:12,borderRadius:8,border:"1px solid #222222"}}>
          <table style={{width:"100%",borderCollapse:"collapse",fontSize:12,minWidth:600}}>
            <thead><tr style={{background:"#111111"}}><th style={{padding:"8px 10px",textAlign:"left",color:"#525252",fontSize:10,textTransform:"uppercase",letterSpacing:0.5,minWidth:150}}>Item</th><th style={{padding:"8px 10px",textAlign:"left",color:"#525252",fontSize:10,textTransform:"uppercase"}}>Vendor</th><th style={{padding:"8px 10px",textAlign:"right",color:"#525252",fontSize:10,textTransform:"uppercase"}}>Ordered</th><th style={{padding:"8px 10px",textAlign:"right",color:"#525252",fontSize:10,textTransform:"uppercase"}}>Received</th><th style={{padding:"8px 10px",textAlign:"right",color:"#525252",fontSize:10,textTransform:"uppercase"}}>Outstanding</th><th style={{padding:"8px 10px",textAlign:"center",color:"#525252",fontSize:10,textTransform:"uppercase"}}>Progress</th><th style={{padding:"8px 10px"}}></th></tr></thead>
            <tbody>{items.map(item=><tr key={item.id} style={{borderBottom:"1px solid #1a1d2720"}}>
              ...
              <td style={{padding:"8px 10px",color:"#737373"}}>{vendors.find(v=>v.id===item.vendor)?.name||"--"}</td>
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
// DOCUMENTS Ã¢ÂÂ Quotes, POs, Invoices, Commission Statements
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function DocumentsPage({jobs,lineItems,vendors,customers,reps,getJobItems,getJobFinancials,updateJob,updateLineItem,notify,qbConfig,setPage,triggerPrint,...ctx}){
  ...
  // Doc statuses stored IN each job record in Supabase Ã¢ÂÂ persists across browsers, deploys, cache clears
  ...
  const setDocStatus = (docNum, status) => {
    ...
    if (jobId) {
      ...
      // Commission statements Ã¢ÂÂ store on first job or use localStorage fallback
  ...
  // Stable doc numbers Ã¢ÂÂ same job+vendor always = same docNum, so statuses persist when you navigate away and back
  ...
  const genInvoice=job=>{const items=getJobItems(job.id).filter(i=>i.qtyReceived>i.qtyInvoiced);return {customer:customers.find(c=>c.id===job.customer),items:items.map(i=>({...i,displayQty:i.qtyReceived-i.qtyInvoiced,displayPrice:i.unitPrice})),total:items.reduce((s,i)=>s+i.unitPrice*(i.qtyReceived-i.qtyInvoiced),0),job,docNum:stableNum('INV-',job.id,job.customer)}};
  const genQuote=job=>{const items=getJobItems(job.id);const customer=customers.find(c=>c.id===job.customer);return {customer,items:items.map(i=>({...i,displayQty:i.qtyOrdered,displayPrice:i.unitPrice})),total:items.reduce((s,i)=>s+i.unitPrice*i.qtyOrdered,0),job,docNum:stableNum('QT-',job.id,job.customer)}};

  const handleExportPDF=(doc)=>{
    const isQuote=doc.type==="quote";
    const isPO=doc.type==="po";
    const isInvoice=!isQuote&&!isPO&&doc.type!=="commission";
    const {customer:cust,vendor:vend,items:docItems,docNum,total:docTotal}=doc.data||{};
    const job=doc.job||{};
    const custObj=customers.find(c=>c.id===(cust||job.customerId))||{};
    const vendObj=vendors.find(v=>v.id===(vend||""))||{};
    const repObj=reps.find(r=>r.id===job.repId)||{};
    const items=(docItems||getJobItems(job.id)||[]);
    const total=docTotal||items.reduce((s,i)=>s+(isPO?(i.cost||0)*(i.qty||1):(i.sellPrice||0)*(i.qty||1)),0);
    const today=new Date();
    const fmtDate=(d)=>{if(!d)return"";const dt=new Date(d);return (dt.getMonth()+1).toString().padStart(2,"0")+"/"+dt.getDate().toString().padStart(2,"0")+"/"+dt.getFullYear();};
    const todayStr=fmtDate(today);
    const terms=job.terms||"Net 30";
    const termDays=terms.includes("15")?15:terms.includes("Receipt")?0:30;
    const dueDate=new Date(today);dueDate.setDate(dueDate.getDate()+termDays);
    const dueDateStr=fmtDate(dueDate);
    const shipVia=job.shipVia||"";
    const poNumber=job.poNumber||"";
    const notes=job.notes||"";
    const rowsHtml=items.map(i=>{const qty=isPO?(i.qtyOrdered||i.qty||1):(i.displayQty||i.qty||1);const price=isPO?(i.cost||i.unitPrice||0):(i.displayPrice||i.sellPrice||i.unitPrice||0);const amt=qty*price;return '<tr><td style="padding:10px 8px;border-bottom:1px solid #eee;vertical-align:top">'+(i.description||"")+'</td><td style="padding:10px 8px;border-bottom:1px solid #eee;text-align:right;vertical-align:top">'+qty+'</td><td style="padding:10px 8px;border-bottom:1px solid #eee;text-align:right;vertical-align:top">'+fmt(price)+'</td><td style="padding:10px 8px;border-bottom:1px solid #eee;text-align:right;vertical-align:top">'+fmt(amt)+'</td></tr>';}).join("");
    const mwHeader='<div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:24px"><div><div style="font-weight:700;font-size:14px">Midwest Educational Furnishings, Inc.</div><div style="font-size:12px;color:#444;line-height:1.6">21191 N Valley Rd<br>Kildeer, IL 60047 US<br>+18478471865</div></div><div><img src="'+MW_LOGO+'" style="height:48px" /></div></div>';
    const tableHeader='<table style="width:100%;border-collapse:collapse;font-size:13px;margin-top:16px"><thead><tr style="border-bottom:2px solid #222"><th style="text-align:left;padding:8px;font-weight:600;color:#2dd4bf">DESCRIPTION</th><th style="text-align:right;padding:8px;font-weight:600;color:#2dd4bf;width:60px">QTY</th><th style="text-align:right;padding:8px;font-weight:600;color:#2dd4bf;width:90px">RATE</th><th style="text-align:right;padding:8px;font-weight:600;color:#2dd4bf;width:100px">AMOUNT</th></tr></thead><tbody>'+rowsHtml+'</tbody></table>';
    let html="";
    if(isPO){
      html='<div style="font-family:Helvetica,Arial,sans-serif;max-width:800px;margin:0 auto;padding:32px;color:#222">'+mwHeader+'<h1 style="font-size:28px;font-weight:300;color:#888;margin:24px 0 16px">Purchase Order</h1><div style="display:flex;justify-content:space-between;margin-bottom:8px"><div style="flex:1"><div style="font-weight:700;font-size:12px;text-transform:uppercase;margin-bottom:4px">Vendor</div><div style="font-size:13px;line-height:1.6">'+(vendObj.name||"")+'<br>'+(vendObj.address||"").replace(/\\n/g,"<br>")+'</div></div><div style="flex:1"><div style="font-weight:700;font-size:12px;text-transform:uppercase;margin-bottom:4px">Ship To</div><div style="font-size:13px;line-height:1.6">'+(custObj.name||"")+'<br>'+(custObj.address||"").replace(/\\n/g,"<br>")+'</div></div><div style="text-align:right"><div style="font-size:13px"><strong>P.O. NO.</strong> '+(docNum||"")+'</div><div style="font-size:13px"><strong>DATE</strong> '+todayStr+'</div></div></div><hr style="border:none;border-top:1px solid #ccc;margin:12px 0">'+(shipVia?'<div style="margin-bottom:12px"><div style="font-weight:700;font-size:12px;text-transform:uppercase;margin-bottom:4px">Ship Via</div><div style="font-size:13px">'+shipVia+'</div></div>':'')+tableHeader+'<div style="margin-top:24px;display:flex;justify-content:space-between"><div style="font-size:12px;color:#666;max-width:50%">'+(notes?notes.replace(/\\n/g,"<br>"):"")+'</div><div style="text-align:right"><div style="font-size:13px;margin-bottom:4px"><span style="margin-right:40px">SUBTOTAL</span>'+fmt(total)+'</div><div style="font-size:16px;font-weight:700"><span style="margin-right:40px">TOTAL</span>'+fmt(total)+'</div></div></div></div>';
    } else if(isInvoice){
      html='<div style="font-family:Helvetica,Arial,sans-serif;max-width:800px;margin:0 auto;padding:32px;color:#222">'+mwHeader+'<div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px"><div style="display:flex;gap:40px"><div><div style="font-weight:700;font-size:12px;text-transform:uppercase;margin-bottom:4px">Bill To</div><div style="font-size:13px;line-height:1.6">'+(custObj.name||"")+'<br>'+(custObj.address||"").replace(/\\n/g,"<br>")+'</div></div><div><div style="font-weight:700;font-size:12px;text-transform:uppercase;margin-bottom:4px">Ship To</div><div style="font-size:13px;line-height:1.6">'+(custObj.name||"")+'<br>'+(custObj.address||"").replace(/\\n/g,"<br>")+'</div></div></div><div style="background:#111;color:#fff;padding:12px 20px;text-align:right;min-width:200px"><div style="font-size:20px;font-weight:700;margin-bottom:8px">INVOICE '+(docNum||"")+'</div><div style="font-size:12px"><strong>DATE</strong> '+todayStr+'&nbsp;&nbsp;<strong>TERMS</strong> '+terms+'</div><div style="font-size:12px;margin-top:4px;color:#2dd4bf"><strong>DUE DATE</strong> '+dueDateStr+'</div></div></div>'+(poNumber?'<div style="margin:12px 0"><div style="font-weight:700;font-size:12px">P.O. NUMBER</div><div style="font-size:13px">'+poNumber+'</div></div>':'')+tableHeader+'<div style="margin-top:24px;text-align:right"><div style="font-size:13px;color:#666;margin-bottom:4px">Thank you for your business! It was a pleasure working with you.</div><div style="display:flex;justify-content:flex-end;gap:40px;margin-top:12px"><div style="text-align:right"><div style="font-size:13px;margin-bottom:4px">SUBTOTAL<span style="margin-left:40px">'+fmt(total)+'</span></div><div style="font-size:18px;font-weight:700;background:#111;color:#fff;padding:8px 16px;display:inline-block">TOTAL DUE<span style="margin-left:40px;color:#2dd4bf">'+fmt(total)+'</span></div></div></div></div></div>';
    } else {
      const name=isPO?(vendObj.name||""):(custObj.name||job.jobName||"");
      const rows2=items.map(i=>{const qty=i.displayQty||i.qty||1;const price=i.displayPrice||i.sellPrice||i.unitPrice||0;const amt=qty*price;return '<tr><td style="padding:8px;border-bottom:1px solid #eee">'+(i.description||"")+'</td><td style="padding:8px;border-bottom:1px solid #eee;text-align:center">'+qty+'</td><td style="padding:8px;border-bottom:1px solid #eee;text-align:right">'+fmt(price)+'</td><td style="padding:8px;border-bottom:1px solid #eee;text-align:right">'+fmt(amt)+'</td></tr>';}).join("");
      html='<div style="font-family:Helvetica,Arial,sans-serif;max-width:800px;margin:0 auto;padding:32px;color:#222">'+mwHeader+'<div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:16px"><div><h1 style="font-size:22px;font-weight:700;margin:0">QUOTE</h1><div style="font-size:13px;color:#666;margin-top:4px">'+(docNum||"")+'</div></div><div style="text-align:right"><div style="font-size:13px"><strong>DATE</strong> '+todayStr+'</div><div style="font-size:13px;margin-top:2px"><strong>CUSTOMER</strong> '+name+'</div></div></div><table style="width:100%;border-collapse:collapse;font-size:13px;margin-top:16px"><thead><tr style="border-bottom:2px solid #222"><th style="text-align:left;padding:8px;font-weight:600">DESCRIPTION</th><th style="text-align:center;padding:8px;font-weight:600;width:60px">QTY</th><th style="text-align:right;padding:8px;font-weight:600;width:90px">RATE</th><th style="text-align:right;padding:8px;font-weight:600;width:100px">AMOUNT</th></tr></thead><tbody>'+rows2+'</tbody></table><div style="margin-top:16px;text-align:right;font-size:15px;font-weight:700">TOTAL: '+fmt(total)+'</div></div>';
    }
    const docTitle=isPO?"Purchase Order":isInvoice?"Invoice":"Quote";
    triggerPrint(docTitle+" - "+(docNum||job.modNumber||""),html);
  };
  ...
  return <div style={{animation:"fadeUp 0.4s"}}><Header title="Documents" sub="Quotes, Purchase Orders, Invoices, Commission Statements"/>
    <div style={{display:"flex",gap:0,alignItems:"center",marginBottom:16,padding:"10px 16px",background:"#111111",borderRadius:8,fontSize:11,color:"#525252"}}><span style={{color:"#2dd4bf",fontWeight:600}}>Workflow:</span><span style={{margin:"0 8px"}}>Quote</span><span style={{color:"#404040"}}>Ã¢ÂÂ</span><span style={{margin:"0 8px",color:"#2dd4bf"}}>Approve/Send</span><span style={{color:"#404040"}}>Ã¢ÂÂ</span><span style={{margin:"0 8px"}}>Purchase Orders</span><span style={{color:"#404040"}}>Ã¢ÂÂ</span><span style={{margin:"0 8px"}}>Draft/Send</span><span style={{color:"#404040"}}>Ã¢ÂÂ</span><span style={{margin:"0 8px"}}>Invoices</span><span style={{color:"#404040"}}>Ã¢ÂÂ</span><span style={{margin:"0 8px",color:"#34d399"}}>Mark Paid</span></div>
    ...
    <div style={{display:"flex",gap:0,marginBottom:24,background:"#111111",borderRadius:12,padding:4,overflow:"hidden"}}>
      {[["quotes","Quotes",totalQuotes,"#2dd4bf"],["pos","Purchase Orders",totalPOs,"#a78bfa"],["invoices","Invoices",pendingInvJobs.length+" pending","#fbbf24"],["commissions","Commissions",reps.filter(r=>!r.id.includes("SEED_FLAG")).length+" reps","#34d399"]].map(([id,label,count,color])=>
        <button key={id} onClick={()=>setTab(id)} style={{flex:1,padding:"14px 12px",borderRadius:8,border:"none",cursor:"pointer",background:tab===id?color+"18":"transparent",color:tab===id?color:"#525252",fontSize:13,fontWeight:tab===id?700:400,fontFamily:"inherit",transition:"all 0.2s",display:"flex",flexDirection:"column",alignItems:"center",gap:4}}>
          <span>{label}</span>
    ...
    {tab==="quotes"&&<div>{jobs.map(job=>{const q=genQuote(job);const customer=customers.find(c=>c.id===job.customer);return <Card key={job.id} style={{marginBottom:12}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><div style={{flex:1}}><div style={{display:"flex",alignItems:"center",gap:8,marginBottom:4}}><span style={{fontSize:14,fontWeight:700,color:"#e5e5e5"}}>{job.name}</span><Badge label={job.phase} color={statusColor(job.phase)}/></div><div style={{fontSize:12,color:"#525252"}}>{customer?.name} ÃÂ· {q.items.length} items ÃÂ· {fmt(q.total)}</div></div><div style={{display:"flex",alignItems:"center",gap:8}}><StatusBadge docNum={q.docNum}/>{docStatuses[q.docNum]==="approved"&&<span style={{fontSize:10,color:"#34d399"}}>POs unlocked</span>}<Btn onClick={()=>{setPreviewDoc({type:"quote",data:q,job});setTab("preview")}}><I n="file" s={14}/> Generate Quote</Btn></div></div></Card>})}</div>}

    {tab==="pos"&&<div>{jobs.map(job=>{const pos=genPOs(job);if(pos.length===0)return null;const quoteDocNum=stableNum('QT-',job.id,job.customer);const quoteStatus=docStatuses[quoteDocNum];const quoteApproved=quoteStatus==="approved"||quoteStatus==="sent";return <Card key={job.id} style={{marginBottom:12,opacity:quoteApproved?1:0.6}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}><div><span style={{fontSize:14,fontWeight:700,color:"#e5e5e5"}}>{job.name}</span><span style={{fontSize:12,color:"#525252",marginLeft:8}}>{pos.length} vendor POs ÃÂ· {fmt(pos.reduce((s,p)=>s+p.total,0))}</span>{!quoteApproved&&<span style={{fontSize:11,color:"#fbbf24",marginLeft:8}}>Quote must be approved or sent first</span>}</div></div><div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))",gap:10}}>{pos.map((po,i)=><div key={i} onClick={()=>{if(!quoteApproved){notify("Approve or send the quote for this job before creating POs","error");return}setPreviewDoc({type:"po",data:po,job});setTab("preview")}} style={{padding:14,background:"#1a1a1a",borderRadius:8,border:"1px solid #222222",cursor:"pointer",transition:"border 0.15s"}} onMouseEnter={e=>e.currentTarget.style.borderColor="#2dd4bf44"} onMouseLeave={e=>e.currentTarget.style.borderColor="rgba(255,255,255,0.04)"}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}><span style={{fontSize:13,fontWeight:600,color:"#d4d4d4"}}>{po.vendor?.name}</span><StatusBadge docNum={po.docNum}/></div><div style={{fontSize:12,color:"#525252"}}>{po.items.length} items</div><div style={{fontSize:16,fontWeight:700,color:"#2dd4bf",fontFamily:"'JetBrains Mono',monospace",marginTop:4}}>{fmt(po.total)}</div></div>)}</div></Card>})}</div>}

    {tab==="invoices"&&<><div style={{marginBottom:12,padding:"12px 16px",background:"#111111",borderRadius:8,border:"1px solid #222222"}}><div style={{fontSize:13,fontWeight:600,color:"#2dd4bf",marginBottom:4}}>How Partial Invoicing Works</div><div style={{fontSize:12,color:"#737373"}}>Invoices are auto-generated from received quantities. If 200 units were ordered, 120 received, and 80 already invoiced, the system drafts an invoice for the remaining 40 units. Each invoice only includes items with uninvoiced received quantities.</div></div><div>{[...jobs].sort((a,b)=>{const aHas=getJobItems(a.id).some(i=>i.qtyReceived>i.qtyInvoiced)?0:1;const bHas=getJobItems(b.id).some(i=>i.qtyReceived>i.qtyInvoiced)?0:1;return aHas-bHas}).map(job=>{const inv=genInvoice(job);const items=getJobItems(job.id);const invoicedTotal=items.reduce((s,i)=>s+i.unitPrice*i.qtyInvoiced,0);const fullTotal=items.reduce((s,i)=>s+i.unitPrice*i.qtyOrdered,0);const isComplete=items.length>0&&items.every(i=>i.qtyInvoiced>=i.qtyOrdered);const hasPending=inv.items.length>0;const customer=customers.find(c=>c.id===job.customer);return <Card key={job.id} style={{marginBottom:12,opacity:isComplete?0.65:1,border:hasPending?"1px solid #d9770630":"1px solid #222222"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}><div style={{flex:1}}><div style={{display:"flex",alignItems:"center",gap:8,marginBottom:4}}><span style={{fontSize:14,fontWeight:700,color:"#e5e5e5"}}>{job.name}</span>{isComplete?<Badge label="fully invoiced" color="#34d399"/>:hasPending?<Badge label="partial ready" color="#fbbf24"/>:<Badge label="awaiting delivery" color="#525252"/>}<StatusBadge docNum={inv.docNum}/></div><div style={{fontSize:12,color:"#525252"}}>{customer?.name} ÃÂ· {fmt(invoicedTotal)} of {fmt(fullTotal)} invoiced</div></div><div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>{(()=>{const jobPOs=genPOs(job);const anyPODrafted=jobPOs.some(po=>docStatuses[po.docNum]&&docStatuses[po.docNum]!=="new");return hasPending?anyPODrafted?<Btn onClick={()=>{setPreviewDoc({type:"invoice",data:inv,job});setTab("preview")}}><I n="receipt" s={14}/> Draft Partial Invoice ({fmt(inv.total)})</Btn>:<span style={{fontSize:11,color:"#fbbf24",padding:"6px 10px"}}>Draft POs first</span>:null})()}{job.paymentStatus!=="paid"&&<Btn v="ghost" style={{fontSize:11}} onClick={()=>{updateJob(job.id,{paymentStatus:isComplete?"paid":"partial"});notify(isComplete?"Marked as paid":"Marked partial payment")}}>Mark {isComplete?"Paid":"Partial"}</Btn>}{job.paymentStatus==="paid"&&<Badge label="paid" color="#34d399"/>}</div></div><Bar value={invoicedTotal} max={fullTotal||1} color={isComplete?"#34d399":"#fbbf24"} height={4}/>{hasPending&&<div style={{marginTop:10,borderTop:"1px solid #222222",paddingTop:10}}><div style={{fontSize:11,fontWeight:600,color:"#fbbf24",marginBottom:6}}>Ready to invoice ({inv.items.length} items ÃÂ· {fmt(inv.total)}):</div>{inv.items.map((item,idx)=><div key={idx} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"4px 0",fontSize:11,color:"#737373"}}><span style={{flex:1}}>{item.description}</span><span style={{display:"flex",gap:12,fontFamily:"'JetBrains Mono',monospace",fontSize:10}}><span>ordered: {fmtN(item.qtyOrdered)}</span><span>received: {fmtN(item.qtyReceived)}</span><span>invoiced: {fmtN(item.qtyInvoiced)}</span><span style={{color:"#fbbf24",fontWeight:600}}>this invoice: {fmtN(item.displayQty)} x {fmt(item.displayPrice)} = {fmt(item.displayQty*item.displayPrice)}</span></span></div>)}</div>}</Card>})}</div></>}

    {tab==="commissions"&&<div>{reps.filter(r=>!r.id.includes("SEED_FLAG")&&r.commissionRate>0).map(rep=>{const rj=jobs.filter(j=>j.salesRep===rep.id);const totalRev=rj.reduce((s,j)=>s+getJobFinancials(j.id).totalRevenue,0);const comm=totalRev*rep.commissionRate;const paidRev=rj.filter(j=>j.paymentStatus==="paid").reduce((s,j)=>s+getJobFinancials(j.id).totalRevenue,0);const paidComm=paidRev*rep.commissionRate;const unpaidComm=comm-paidComm;const docNum=stableNum('COMM-',rep.id,'stmt');return <Card key={rep.id} style={{marginBottom:12,border:unpaidComm>0?"1px solid #d9770625":"1px solid #222222"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><div style={{flex:1}}><div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}><span style={{fontSize:15,fontWeight:700,color:"#e5e5e5"}}>{rep.name}</span><Badge label={rep.tier} color="#2dd4bf"/><Badge label={pct(rep.commissionRate*100)} color="#34d399"/><StatusBadge docNum={docNum}/></div><div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(100px,1fr))",gap:8,fontSize:12}}><div style={{padding:"6px 10px",background:"#111111",borderRadius:6,textAlign:"center"}}><div style={{fontSize:10,color:"#525252"}}>Jobs</div><div style={{fontWeight:700,color:"#e5e5e5",fontFamily:"'JetBrains Mono',monospace"}}>{rj.length}</div></div><div style={{padding:"6px 10px",background:"#111111",borderRadius:6,textAlign:"center"}}><div style={{fontSize:10,color:"#525252"}}>Pipeline</div><div style={{fontWeight:700,color:"#2dd4bf",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(totalRev)}</div></div><div style={{padding:"6px 10px",background:"#05966910",borderRadius:6,textAlign:"center"}}><div style={{fontSize:10,color:"#34d399"}}>Earned</div><div style={{fontWeight:700,color:"#34d399",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(paidComm)}</div></div><div style={{padding:"6px 10px",background:"#d9770610",borderRadius:6,textAlign:"center"}}><div style={{fontSize:10,color:"#fbbf24"}}>Pending</div><div style={{fontWeight:700,color:"#fbbf24",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(unpaidComm)}</div></div><div style={{padding:"6px 10px",background:"#2dd4bf10",borderRadius:6,textAlign:"center"}}><div style={{fontSize:10,color:"#2dd4bf"}}>Total Comm.</div><div style={{fontWeight:700,color:"#2dd4bf",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(comm)}</div></div></div></div><div style={{display:"flex",flexDirection:"column",gap:6,marginLeft:16}}><Btn onClick={()=>{const items=rj.map(j=>{const f=getJobFinancials(j.id);const isPaid=j.paymentStatus==="paid";return{description:j.name+' Ã¢ÂÂ '+(customers.find(c=>c.id===j.customer)?.name||'')+' Ã¢ÂÂ '+(isPaid?'PAID':'PENDING'),displayQty:1,displayPrice:f.totalRevenue*rep.commissionRate}});setPreviewDoc({type:"commission",data:{rep,items,total:comm,docNum},job:{id:'ALL',name:rep.name+' Commission Statement',notes:'Period: '+new Date().toLocaleDateString()+'\nEarned (paid jobs): '+fmt(paidComm)+'\nPending (unpaid jobs): '+fmt(unpaidComm)+'\nTotal commission: '+fmt(comm)}});setTab("preview")}}><I n="file" s={14}/> Generate Statement</Btn>{rj.length>0&&<div style={{display:"flex",gap:4}}>{["drafted","sent","approved"].map(s=><button key={s} onClick={()=>setDocStatus(docNum,s)} style={{padding:"3px 8px",borderRadius:4,border:"1px solid "+(docStatuses[docNum]===s?"#2dd4bf":"#333333"),background:docStatuses[docNum]===s?"#2dd4bf15":"transparent",color:docStatuses[docNum]===s?"#2dd4bf":"#404040",fontSize:9,fontFamily:"inherit",cursor:"pointer"}}>{s}</button>)}</div>}</div></div>{rj.length>0&&<div style={{marginTop:10}}><Bar value={paidRev} max={totalRev||1} color="#34d399" height={3}/></div>}{rj.length>0&&<div style={{marginTop:8,fontSize:11,color:"#525252"}}><strong>Jobs:</strong> {rj.map(j=>{const isPaid=j.paymentStatus==="paid";return <span key={j.id} style={{marginRight:8}}><span style={{color:isPaid?"#34d399":"#fbbf24"}}>{isPaid?"Ã¢ÂÂ":"Ã¢ÂÂ"}</span> {j.name} ({fmt(getJobFinancials(j.id).totalRevenue*rep.commissionRate)})</span>})}</div>}</Card>})}{reps.filter(r=>!r.id.includes("SEED_FLAG")&&r.commissionRate===0&&jobs.some(j=>j.salesRep===r.id)).length>0&&<Card style={{marginTop:8,opacity:0.6}}><div style={{fontSize:13,color:"#525252"}}>Team members without commission rates: {reps.filter(r=>!r.id.includes("SEED_FLAG")&&r.commissionRate===0).map(r=>r.name).join(', ')}</div></Card>}</div>}

    {tab==="preview"&&previewDoc&&<Card style={{border:"1px solid #2dd4bf30"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16,flexWrap:"wrap",gap:8}}><div style={{display:"flex",alignItems:"center",gap:12}}><div style={{fontSize:16,fontWeight:700,color:"#2dd4bf"}}>{previewDoc.type==="quote"?"PROJECT QUOTE":previewDoc.type==="po"?"PURCHASE ORDER":previewDoc.type==="commission"?"COMMISSION STATEMENT":"INVOICE"}</div><StatusBadge docNum={previewDoc.data.docNum}/></div><div style={{display:"flex",gap:8,flexWrap:"wrap"}}>{previewDoc.data.docNum&&<div style={{display:"flex",gap:4}}>{["drafted","sent","approved"].map(s=><button key={s} onClick={()=>setDocStatus(previewDoc.data.docNum,s)} style={{padding:"4px 10px",borderRadius:6,border:"1px solid "+(docStatuses[previewDoc.data.docNum]===s?"#2dd4bf":"#333333"),background:docStatuses[previewDoc.data.docNum]===s?"#2dd4bf20":"transparent",color:docStatuses[previewDoc.data.docNum]===s?"#2dd4bf":"#525252",fontSize:10,fontFamily:"inherit",cursor:"pointer",textTransform:"capitalize"}}>{s}</button>)}</div>}<Btn onClick={()=>handleExportPDF(previewDoc)}><I n="download" s={14}/> Export PDF</Btn><Btn v="ghost" onClick={()=>{const doc=previewDoc;const isQuote=doc.type==="quote";const isPO=doc.type==="po";const isComm=doc.type==="commission";const recipient=isQuote?doc.data.customer?.email:isPO?doc.data.vendor?.email:isComm?doc.data.rep?.email:doc.data.customer?.email;setEmailTo(recipient||"");setEmailSubject((isQuote?"Project Quote":isPO?"Purchase Order":isComm?"Commission Statement":"Invoice")+" - "+doc.job.name+" - "+(doc.data.docNum||""));setEmailModal(doc)}}><I n="send" s={14}/> Email</Btn>{previewDoc.type!=="quote"&&previewDoc.type!=="commission"&&<Btn v={qbConfig.connected?"primary":"secondary"} onClick={()=>qbConfig.connected?pushToQB(previewDoc):setPage("qbsetup")} style={pushing?{opacity:0.6,pointerEvents:"none"}:{}}><I n="send" s={14}/> {pushing?"Pushing...":qbConfig.connected?"Push to QB":"Connect QB"}</Btn>}<Btn v="secondary" onClick={()=>setTab(previewDoc.type==="commission"?"commissions":previewDoc.type==="quote"?"quotes":previewDoc.type==="po"?"pos":"invoices")}>&larr; Back</Btn>{previewDoc.type==="invoice"&&previewDoc.data.items.length>0&&<Btn v="ghost" style={{fontSize:11,color:"#34d399",border:"1px solid #05966930"}} onClick={()=>{previewDoc.data.items.forEach(item=>{if(item.qtyReceived>item.qtyInvoiced){ctx.updateLineItem(item.id,{qtyInvoiced:item.qtyReceived,invoiceDate:new Date().toISOString().split("T")[0]})}});notify("All "+previewDoc.data.items.length+" items marked as invoiced")}}>Mark All Invoiced</Btn>}</div></div>
      {emailModal&&<div style={{background:"#1a1a1a",border:"1px solid #2dd4bf30",borderRadius:8,padding:20,marginBottom:16}}><div style={{fontSize:14,fontWeight:700,color:"#2dd4bf",marginBottom:12}}>Email Document</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:12}}><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>From (your email)</label><input value={emailFrom} onChange={e=>setEmailFrom(e.target.value)} placeholder="lisa@mwfurnishings.com" style={inputStyle}/></div><div><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>To (recipient)</label><input value={emailTo} onChange={e=>setEmailTo(e.target.value)} placeholder="recipient@email.com" style={inputStyle}/></div></div><div style={{marginBottom:12}}><label style={{fontSize:11,color:"#525252",display:"block",marginBottom:4}}>Subject</label><input value={emailSubject} onChange={e=>setEmailSubject(e.target.value)} style={inputStyle}/></div><div style={{display:"flex",gap:8}}><Btn onClick={sendEmail} style={emailSending?{opacity:0.6,pointerEvents:"none"}:{}}>{emailSending?"Sending...":"Send Email"}</Btn><Btn v="secondary" onClick={()=>setEmailModal(null)}>Cancel</Btn></div><div style={{fontSize:10,color:"#404040",marginTop:8}}>To send to any recipient, verify your domain at resend.com/domains. Without domain verification, emails can only be sent to the Resend account owner email.</div></div>}
      <div style={{background:"#fff",color:"#111",borderRadius:8,padding:32,fontFamily:"'Satoshi',sans-serif"}}><div style={{display:"flex",justifyContent:"space-between",borderBottom:"2px solid #2dd4bf",paddingBottom:16,marginBottom:20}}><div><img src={MW_LOGO} alt="MW" style={{height:32,marginBottom:6}}/><div style={{fontSize:20,fontWeight:800}}>MIDWEST EDUCATIONAL FURNISHINGS</div><div style={{fontSize:11,color:"#999",marginTop:2}}>Designing Spaces | Building Futures</div><div style={{fontSize:12,color:"#666",marginTop:4}}>(847) 847-1865 ÃÂ· info@mwfurnishings.com ÃÂ· www.mwfurnishings.com</div></div><div style={{textAlign:"right"}}><div style={{fontSize:14,fontWeight:700,color:"#2dd4bf",textTransform:"uppercase"}}>{previewDoc.type==="quote"?"Project Quote":previewDoc.type==="po"?"Purchase Order":previewDoc.type==="commission"?"Commission Statement":"Invoice"}</div><div style={{fontSize:12,fontWeight:600,color:"#333"}}>{previewDoc.data.docNum||""}</div><div style={{fontSize:12,color:"#666",marginTop:4}}>Date: {new Date().toLocaleDateString()}</div><div style={{fontSize:12,color:"#666"}}>Job: {previewDoc.job.id}</div>{previewDoc.type==="quote"&&<div style={{fontSize:11,color:"#999",marginTop:2}}>Valid for 30 days</div>}</div></div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:24,marginBottom:24}}><div><div style={{fontSize:11,fontWeight:700,color:"#999",textTransform:"uppercase",marginBottom:4}}>{previewDoc.type==="quote"?"Prepared For":previewDoc.type==="po"?"Vendor":previewDoc.type==="commission"?"Sales Rep":"Bill To"}</div><div style={{fontSize:13,fontWeight:600}}>{previewDoc.type==="quote"?previewDoc.data.customer?.name:previewDoc.type==="po"?previewDoc.data.vendor?.name:previewDoc.type==="commission"?previewDoc.data.rep?.name:previewDoc.data.customer?.name}</div></div><div><div style={{fontSize:11,fontWeight:700,color:"#999",textTransform:"uppercase",marginBottom:4}}>Project</div><div style={{fontSize:13,fontWeight:600}}>{previewDoc.job.name}</div>{previewDoc.job.notes&&<div style={{fontSize:11,color:"#888",marginTop:2}}>{previewDoc.job.notes}</div>}</div></div>
        <table style={{width:"100%",borderCollapse:"collapse",fontSize:12,marginBottom:20}}><thead><tr style={{borderBottom:"1px solid #ddd"}}><th style={{padding:"8px 4px",textAlign:"left",color:"#666"}}>Description</th><th style={{padding:"8px 4px",textAlign:"right",color:"#666"}}>Qty</th><th style={{padding:"8px 4px",textAlign:"right",color:"#666"}}>Unit Price</th><th style={{padding:"8px 4px",textAlign:"right",color:"#666"}}>Total</th></tr></thead><tbody>{previewDoc.data.items.map((item,i)=>{const qty=item.displayQty!==undefined?item.displayQty:item.qtyOrdered;const price=item.displayPrice!==undefined?item.displayPrice:item.unitPrice;return <tr key={i} style={{borderBottom:"1px solid #eee"}}><td style={{padding:"8px 4px"}}>{item.description}</td><td style={{padding:"8px 4px",textAlign:"right"}}>{qty}</td><td style={{padding:"8px 4px",textAlign:"right"}}>{fmt(price)}</td><td style={{padding:"8px 4px",textAlign:"right",fontWeight:600}}>{fmt(qty*price)}</td></tr>})}</tbody><tfoot><tr style={{borderTop:"2px solid #2dd4bf"}}><td colSpan="3" style={{padding:"10px 4px",fontWeight:700,textAlign:"right"}}>TOTAL</td><td style={{padding:"10px 4px",fontWeight:700,textAlign:"right",fontSize:14}}>{fmt(previewDoc.data.total)}</td></tr></tfoot></table>
      </div>
    </Card>}
  </div>;
}
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
// COMMISSIONS Ã¢ÂÂ Editable Reps + PDF Export
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function CommissionsPage({jobs,reps,customers,updateRep,addRep,deleteRep,getJobFinancials,notify,triggerPrint}){
  ...
  const saveEdit=()=>{updateRep(editingRep,{name:editForm.name,email:editForm.email,territory:editForm.territory,commissionRate:parseFloat(editForm.commissionRate)||0,tier:editForm.tier});setEditingRep(null);notify("Sales rep updated Ã¢ÂÂ commissions recalculated everywhere")};
  ...
  return <div style={{animation:"fadeUp 0.4s"}}><Header title="Commission Engine" sub="Editable reps, customizable rates Ã¢ÂÂ auto-calculated on every job" action={<Btn onClick={()=>setAddingRep(true)}><I n="plus" s={14}/> Add Sales Rep</Btn>}/>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16,marginBottom:24}}>{reps.map(rep=>{const rj=jobs.filter(j=>j.salesRep===rep.id);const totalRev=rj.reduce((s,j)=>s+getJobFinancials(j.id).totalRevenue,0);const paidRev=rj.filter(j=>j.paymentStatus==="paid").reduce((s,j)=>s+getJobFinancials(j.id).totalRevenue,0);const isEd=editingRep===rep.id;
      ...
      return <Card key={rep.id} style={{border:isEd?"1px solid #2dd4bf44":undefined}}>
        {isEd?<div><div style={{fontSize:14,fontWeight:700,marginBottom:12,color:"#2dd4bf"}}>Edit Sales Rep</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:8}}><div><label style={{fontSize:10,color:"#525252",display:"block",marginBottom:3}}>Name</label><input value={editForm.name} onChange={e=>setEditForm({...editForm,name:e.target.value})} style={inputStyle}/></div><div><label style={{fontSize:10,color:"#525252",display:"block",marginBottom:3}}>Email</label><input value={editForm.email} onChange={e=>setEditForm({...editForm,email:e.target.value})} style={inputStyle}/></div><div><label style={{fontSize:10,color:"#525252",display:"block",marginBottom:3}}>Territory</label><input value={editForm.territory} onChange={e=>setEditForm({...editForm,territory:e.target.value})} style={inputStyle}/></div><div><label style={{fontSize:10,color:"#525252",display:"block",marginBottom:3}}>Commission Rate (%)</label><input type="number" step="0.5" value={(editForm.commissionRate*100).toFixed(1)} onChange={e=>setEditForm({...editForm,commissionRate:parseFloat(e.target.value)/100||0})} style={inputStyle}/></div><div><label style={{fontSize:10,color:"#525252",display:"block",marginBottom:3}}>Tier</label><select value={editForm.tier} onChange={e=>setEditForm({...editForm,tier:e.target.value})} style={inputStyle}>{["Associate","Mid-Level","Senior"].map(t=><option key={t}>{t}</option>)}</select></div></div><div style={{display:"flex",gap:8}}><Btn onClick={saveEdit}>Save</Btn><Btn v="secondary" onClick={()=>setEditingRep(null)}>Cancel</Btn><Btn v="danger" onClick={()=>{deleteRep(rep.id);setEditingRep(null);notify("Sales rep removed")}}>Delete</Btn></div></div>

        :<><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}><div><div style={{fontSize:15,fontWeight:700,color:"#e5e5e5"}}>{rep.name}</div><div style={{fontSize:12,color:"#525252"}}>{rep.territory} ÃÂ· {rep.tier}</div></div><div style={{display:"flex",gap:6}}><Badge label={`${(rep.commissionRate*100).toFixed(1)}%`} color="#2dd4bf"/><button onClick={()=>startEdit(rep)} style={{background:"none",border:"none",cursor:"pointer",color:"#525252",padding:2}}><I n="edit" s={14}/></button></div></div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}><div><div style={{fontSize:11,color:"#525252"}}>Earned (Paid)</div><div style={{fontSize:18,fontWeight:700,color:"#34d399",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(paidRev*rep.commissionRate)}</div></div><div><div style={{fontSize:11,color:"#525252"}}>Projected (All)</div><div style={{fontSize:18,fontWeight:700,color:"#2dd4bf",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(totalRev*rep.commissionRate)}</div></div></div>
        <div style={{marginTop:12}}><Bar value={paidRev} max={totalRev||1} color="#34d399" height={4}/><div style={{display:"flex",justifyContent:"space-between",marginTop:4}}><span style={{fontSize:11,color:"#525252"}}>{rj.length} jobs ÃÂ· {fmt(totalRev)} revenue</span><Btn v="ghost" style={{fontSize:10,padding:"3px 8px"}} onClick={()=>{setSelectedRep(rep.id===selectedRep?null:rep.id)}}>Statement</Btn></div></div>
...
function SalesPortalPage({jobs,reps,customers,lineItems,getJobFinancials,vendors}){
  ...
  return <div style={{animation:"fadeUp 0.4s"}}><Header title="Sales Portal" sub="Company overview and per-rep dashboards"/>
    ...
    <Card style={{marginBottom:20,background:"linear-gradient(135deg,#0a0a0a,#111111)"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:16}}><div><div style={{fontSize:20,fontWeight:800,color:"#e5e5e5"}}>{isOverview?"Midwest Educational Furnishings":rep.name}</div><div style={{fontSize:13,color:"#525252"}}>{isOverview?"All team members ÃÂ· All territories":rep.territory+" ÃÂ· "+rep.tier+(commRate>0?" ÃÂ· "+pct(commRate*100)+" rate":"")}</div></div><div style={{display:"flex",gap:20,flexWrap:"wrap"}}><div style={{textAlign:"center"}}><div style={{fontSize:10,color:"#525252"}}>Total Pipeline</div><div style={{fontSize:22,fontWeight:700,color:"#2dd4bf",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(totalRev)}</div></div><div style={{textAlign:"center"}}><div style={{fontSize:10,color:"#525252"}}>Quoting</div><div style={{fontSize:22,fontWeight:700,color:"#8b5cf6",fontFamily:"'JetBrains Mono',monospace"}}>{quotingJobs.length}</div></div><div style={{textAlign:"center"}}><div style={{fontSize:10,color:"#525252"}}>Active</div><div style={{fontSize:22,fontWeight:700,color:"#a78bfa",fontFamily:"'JetBrains Mono',monospace"}}>{activeJobs.length}</div></div><div style={{textAlign:"center"}}><div style={{fontSize:10,color:"#525252"}}>Paid Revenue</div><div style={{fontSize:22,fontWeight:700,color:"#34d399",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(paidRev)}</div></div>{!isOverview&&commRate>0&&<div style={{textAlign:"center"}}><div style={{fontSize:10,color:"#525252"}}>Commission</div><div style={{fontSize:22,fontWeight:700,color:"#fbbf24",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(totalRev*commRate)}</div></div>}</div></div></Card>

    {isOverview&&<Card style={{marginBottom:16}}><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:12}}>Team Performance</div>{reps.filter(r=>!r.id.includes("SEED_FLAG")).map(r=>{const rJobs=jobs.filter(j=>j.salesRep===r.id);const rv=rJobs.reduce((s,j)=>s+getJobFinancials(j.id).totalRevenue,0);return <div key={r.id} style={{display:"flex",alignItems:"center",gap:12,padding:"10px 0",borderBottom:"1px solid #222222",cursor:"pointer"}} onClick={()=>setActiveRep(r.id)}><div style={{width:36,height:36,borderRadius:8,background:"#1a1a1a",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,color:"#2dd4bf"}}>{r.name.split(" ").map(n=>n[0]).join("")}</div><div style={{flex:1}}><div style={{fontSize:13,fontWeight:600,color:"#e5e5e5"}}>{r.name}</div><div style={{fontSize:11,color:"#525252"}}>{r.territory} ÃÂ· {r.tier}</div></div><div style={{textAlign:"right"}}><div style={{fontSize:13,fontWeight:600,color:"#2dd4bf",fontFamily:"'JetBrains Mono',monospace"}}>{fmt(rv)}</div><div style={{fontSize:10,color:"#525252"}}>{rJobs.length} jobs</div></div></div>})}</Card>}
    ...
    <div className="resp-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:16}}>
      ...
      <Card><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:12}}>Pending Deliveries ({pendingItems.length})</div>{pendingItems.length===0?<div style={{fontSize:12,color:"#34d399"}}>All deliveries complete</div>:pendingItems.slice(0,8).map(item=><div key={item.id} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"6px 0",borderBottom:"1px solid #222222"}}><div><div style={{fontSize:12,color:"#a3a3a3"}}>{item.description}</div><div style={{fontSize:10,color:"#525252"}}>{jobs.find(j=>j.id===item.jobId)?.name}</div></div><span style={{fontSize:11,color:"#fbbf24",fontFamily:"'JetBrains Mono',monospace"}}>{fmtN(item.qtyOrdered-item.qtyReceived)} pending</span></div>)}</Card>
    </div>
    <Card><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:12}}>{isOverview?"All Jobs":"Jobs for "+rep.name}</div><Tbl columns={[
      ...
      {header:"Payment",render:r=><Badge label={r.paymentStatus} color={statusColor(r.paymentStatus)}/>},
      {header:"Due",render:r=><span style={{fontSize:11,color:r.dueDate&&new Date(r.dueDate)<new Date()?"#f87171":"#525252"}}>{r.dueDate||"TBD"}</span>},
    ]} data={rj}/></Card>
  </div>;
}
...
function BrainPage({jobs,reps,lineItems,vendors,customers,getJobFinancials,brainQuery,setBrainQuery,brainLoading,setBrainLoading}){
  const [history,setHistory]=useState([{role:"system",content:"Welcome to the Midwest Brain. I have access to all your live data Ã¢ÂÂ vendors, jobs, deliveries, financials. Ask me anything."}]);
  ...
  const buildAnswer = (q) => {
    ...
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ VENDOR QUERIES Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    ...
    if (matchedVendor || ql.includes("vendor")) {
      if (matchedVendor) {
        ...
        return `**${matchedVendor.name}**\n\nContact: ${matchedVendor.contact}\nEmail: ${matchedVendor.email}\nPhone: ${matchedVendor.phone}\nCategory: ${matchedVendor.category}\nAddress: ${matchedVendor.address || 'Not set'}\n\n**History from your data:**\nÃ¢ÂÂ¢ Total spend: ${fmt(totalSpend)}\nÃ¢ÂÂ¢ ${vendorItems.length} line items across ${jobIds.length} jobs\nÃ¢ÂÂ¢ Average unit cost: ${fmt(avgCost)}\nÃ¢ÂÂ¢ Jobs: ${jobIds.map(id => jobs.find(j => j.id === id)?.name || id).join(', ')}`;
      }
      return `**All Vendors (${vendors.length}):**\n\n${vendors.map(v => { const spend = lineItems.filter(li => li.vendor === v.id).reduce((s, i) => s + i.unitCost * i.qtyOrdered, 0); return `Ã¢ÂÂ¢ **${v.name}** (${v.category}) Ã¢ÂÂ ${fmt(spend)} total spend Ã¢ÂÂ ${v.contact}`; }).join('\n')}`;
    }
    
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ CUSTOMER QUERIES Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    ...
    if (matchedCust || ql.includes("customer") || ql.includes("school") || ql.includes("district")) {
      if (matchedCust) {
        ...
        return `**${matchedCust.name}** (${matchedCust.type})\n\nContact: ${matchedCust.contact}\nEmail: ${matchedCust.email}\nPhone: ${matchedCust.phone}\nAddress: ${matchedCust.address || 'Not set'}\n\n**History:**\nÃ¢ÂÂ¢ ${custJobs.length} jobs Ã¢ÂÂ ${fmt(totalRev)} total revenue\nÃ¢ÂÂ¢ Average margin: ${pct(avgMargin)}\nÃ¢ÂÂ¢ Jobs: ${custJobs.map(j => `${j.name} (${j.phase})`).join(', ')}`;
      }
      return `**All Customers (${customers.length}):**\n\n${customers.map(c => { const rev = jobs.filter(j => j.customer === c.id).reduce((s, j) => s + getJobFinancials(j.id).totalRevenue, 0); return `Ã¢ÂÂ¢ **${c.name}** (${c.type}) Ã¢ÂÂ ${fmt(rev)} revenue Ã¢ÂÂ ${c.contact}`; }).join('\n')}`;
    }
    
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ COMMISSION QUERIES Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    if (ql.includes("commission") || ql.includes("sales rep") || ql.includes("rep")) {
      return `**Commission Structure (Live Data):**\n\n${reps.map(rep => { const rv = jobs.filter(j => j.salesRep === rep.id).reduce((s, j) => s + getJobFinancials(j.id).totalRevenue, 0); const paidRv = jobs.filter(j => j.salesRep === rep.id && j.paymentStatus === 'paid').reduce((s, j) => s + getJobFinancials(j.id).totalRevenue, 0); return `Ã¢ÂÂ¢ **${rep.name}** (${rep.tier}) Ã¢ÂÂ ${(rep.commissionRate * 100).toFixed(1)}% rate\n  Pipeline: ${fmt(rv)} Ã¢ÂÂ Earned: ${fmt(paidRv * rep.commissionRate)} Ã¢ÂÂ Projected: ${fmt(rv * rep.commissionRate)}`; }).join('\n\n')}\n\n**Total pipeline:** ${fmt(jobs.reduce((s, j) => s + getJobFinancials(j.id).totalRevenue, 0))}`;
    }
    
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ JOB QUERIES Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    if (ql.includes("job") || ql.includes("status") || ql.includes("active") || ql.includes("project")) {
      ...
      return `**Jobs (${jobs.length} total):**\n\n${Object.entries(byPhase).map(([phase, count]) => `Ã¢ÂÂ¢ ${phase}: ${count}`).join('\n')}\n\n${jobs.map(j => { const f = getJobFinancials(j.id); return `Ã¢ÂÂ¢ **${j.name}** (${j.id})\n  ${j.phase} Ã¢ÂÂ ${fmt(f.totalRevenue)} Ã¢ÂÂ ${fmtN(f.totalReceived)}/${fmtN(f.totalOrdered)} delivered Ã¢ÂÂ ${j.paymentStatus}`; }).join('\n\n')}`;
    }
    
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ MARGIN QUERIES Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    if (ql.includes("margin") || ql.includes("profit") || ql.includes("profitab")) {
      ...
      return `**Margin Analysis (Live Data):**\n\nÃ¢ÂÂ¢ Average margin across all jobs: **${pct(avgMargin)}**\nÃ¢ÂÂ¢ Best margin: **${best?.name}** at ${pct(best?.margin || 0)}\nÃ¢ÂÂ¢ Lowest margin: **${worst?.name}** at ${pct(worst?.margin || 0)}\nÃ¢ÂÂ¢ Total profit: ${fmt(margins.reduce((s, m) => s + m.totalRevenue - m.totalCost, 0))}\n\n${margins.sort((a, b) => b.margin - a.margin).map(m => `Ã¢ÂÂ¢ ${m.name}: ${pct(m.margin)} margin Ã¢ÂÂ ${fmt(m.totalRevenue)} revenue`).join('\n')}`;
    }
    
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ DELIVERY QUERIES Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    if (ql.includes("delivery") || ql.includes("partial") || ql.includes("shipment") || ql.includes("outstanding")) {
      ...
      return `**Delivery Status (Live Data):**\n\nÃ¢ÂÂ¢ Overall: ${fmtN(totalRcv)} / ${fmtN(totalOrd)} units received (${pct(totalOrd ? totalRcv / totalOrd * 100 : 0)})\nÃ¢ÂÂ¢ ${pending.length} line items still pending\n\n**Outstanding items:**\n${pending.map(i => { const job = jobs.find(j => j.id === i.jobId); const vendor = vendors.find(v => v.id === i.vendor); return `Ã¢ÂÂ¢ ${i.description} Ã¢ÂÂ ${fmtN(i.qtyOrdered - i.qtyReceived)} outstanding Ã¢ÂÂ ${vendor?.name || 'Unknown'} Ã¢ÂÂ ${job?.name || 'Unknown job'}`; }).join('\n')}`;
    }
    
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ INVOICE QUERIES Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    if (ql.includes("invoice") || ql.includes("billing") || ql.includes("receivable")) {
      ...
      return `**Invoice Status (Live Data):**\n\nÃ¢ÂÂ¢ ${uninvoiced.length} line items received but not yet invoiced\nÃ¢ÂÂ¢ Uninvoiced value: **${fmt(uninvTotal)}**\n\n**Ready to invoice:**\n${uninvoiced.map(i => { const job = jobs.find(j => j.id === i.jobId); return `Ã¢ÂÂ¢ ${i.description} Ã¢ÂÂ ${fmtN(i.qtyReceived - i.qtyInvoiced)} units ÃÂ ${fmt(i.unitPrice)} = ${fmt(i.unitPrice * (i.qtyReceived - i.qtyInvoiced))} Ã¢ÂÂ ${job?.name || ''}`; }).join('\n')}`;
    }
    
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ REVENUE / FINANCIAL QUERIES Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    if (ql.includes("revenue") || ql.includes("financial") || ql.includes("money") || ql.includes("total")) {
      ...
      return `**Financial Overview (Live Data):**\n\nÃ¢ÂÂ¢ Total pipeline revenue: **${fmt(totalRev)}**\nÃ¢ÂÂ¢ Total cost: ${fmt(totalCost)}\nÃ¢ÂÂ¢ Total profit: **${fmt(totalRev - totalCost)}**\nÃ¢ÂÂ¢ Average margin: ${pct(jobs.reduce((s, j) => s + getJobFinancials(j.id).margin, 0) / jobs.length)}\n\n**Revenue by Rep:**\n${byRep.map(r => `Ã¢ÂÂ¢ ${r.name}: ${fmt(r.rev)}`).join('\n')}\n\n**By Payment Status:**\nÃ¢ÂÂ¢ Paid: ${fmt(jobs.filter(j => j.paymentStatus === 'paid').reduce((s, j) => s + getJobFinancials(j.id).totalRevenue, 0))}\nÃ¢ÂÂ¢ Partial: ${fmt(jobs.filter(j => j.paymentStatus === 'partial').reduce((s, j) => s + getJobFinancials(j.id).totalRevenue, 0))}\nÃ¢ÂÂ¢ Unpaid: ${fmt(jobs.filter(j => j.paymentStatus === 'unpaid').reduce((s, j) => s + getJobFinancials(j.id).totalRevenue, 0))}`;
    }
    
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ DEFAULT Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    return `I have access to your full database with **${jobs.length} jobs**, **${vendors.length} vendors**, **${customers.length} customers**, **${reps.length} reps**, and **${lineItems.length} line items**.\n\nTry asking:\nÃ¢ÂÂ¢ "Show me all vendors" or "Tell me about Virco"\nÃ¢ÂÂ¢ "What are our margins?"\nÃ¢ÂÂ¢ "Commission breakdown"\nÃ¢ÂÂ¢ "What's outstanding for delivery?"\nÃ¢ÂÂ¢ "Revenue overview"\nÃ¢ÂÂ¢ "Uninvoiced items"\nÃ¢ÂÂ¢ "Tell me about Lincoln" (any customer name)\nÃ¢ÂÂ¢ "Active job status"`;
  };
...
function DirectoryPage({vendors,customers,reps,updateVendor,addVendor,deleteVendor,updateCustomer,addCustomer,deleteCustomer,updateRep,addRep,deleteRep,notify}){
  ...
  const save=()=>{
    ...
    if(adding){
      ...
      notify("Updated Ã¢ÂÂ changes propagated");
    }
  ...
  // render helper (NOT a React component Ã¢ÂÂ prevents remount/focus loss on each keystroke)
  ...
  return <div style={{animation:"fadeUp 0.4s"}}><Header title="Directory" sub="Manage all vendors, customers, and sales reps Ã¢ÂÂ edit, add, sort" action={<Btn onClick={startAdd}><I n="plus" s={14}/> Add {tab==="vendors"?"Vendor":tab==="customers"?"Customer":"Sales Rep"}</Btn>}/>
    ...
    {tab==="vendors"&&<><div style={{marginBottom:8,display:"flex",gap:8,alignItems:"center"}}><span style={{fontSize:12,color:"#525252"}}>Sort by:</span>{["name","category","contact"].map(s=><button key={s} onClick={()=>setSort(s)} style={{fontSize:11,padding:"3px 10px",borderRadius:6,border:"none",cursor:"pointer",background:sort===s?"#2dd4bf22":"transparent",color:sort===s?"#2dd4bf":"#525252",fontFamily:"inherit"}}>{s}</button>)}</div>
      <Tbl columns={[{header:"Name",render:r=><span style={{fontWeight:600,color:"#e5e5e5"}}>{r.name}</span>},{header:"Contact",render:r=>r.contact},{header:"Email",render:r=><span style={{color:"#2dd4bf"}}>{r.email}</span>},{header:"Phone",render:r=>r.phone},{header:"Category",render:r=>r.category},{header:"Discount",render:r=><span style={{fontFamily:"'JetBrains Mono',monospace",color:"#34d399",fontWeight:600}}>{r.discountRate?(r.discountRate*100).toFixed(0)+'%':'--'}</span>},{header:"Discount Notes",render:r=><span style={{fontSize:11,color:"#737373"}}>{r.discountNotes||"--"}</span>},{header:"",render:r=><Btn v="ghost" style={{fontSize:10,padding:"3px 8px"}} onClick={e=>{e.stopPropagation();startEdit(r)}}>Edit</Btn>}]} data={sortedVendors}/></>}

    {tab==="customers"&&<><div style={{marginBottom:8,display:"flex",gap:8,alignItems:"center"}}><span style={{fontSize:12,color:"#525252"}}>Sort by:</span>{["name","type","contact"].map(s=><button key={s} onClick={()=>setSort(s)} style={{fontSize:11,padding:"3px 10px",borderRadius:6,border:"none",cursor:"pointer",background:sort===s?"#2dd4bf22":"transparent",color:sort===s?"#2dd4bf":"#525252",fontFamily:"inherit"}}>{s}</button>)}</div>
      <Tbl columns={[{header:"Name",render:r=><span style={{fontWeight:600,color:"#e5e5e5"}}>{r.name}</span>},{header:"Contact",render:r=>r.contact},{header:"Email",render:r=><span style={{color:"#2dd4bf"}}>{r.email}</span>},{header:"Phone",render:r=>r.phone},{header:"Type",render:r=> <Badge label={r.type} color="#a78bfa"/>},{header:"Address",render:r=><span style={{fontSize:12,color:"#737373"}}>{r.address||"Ã¢ÂÂ"}</span>},{header:"",render:r=><Btn v="ghost" style={{fontSize:10,padding:"3px 8px"}} onClick={e=>{e.stopPropagation();startEdit(r)}}>Edit</Btn>}]} data={sortedCustomers}/></>}

    {tab==="reps"&&<><div style={{marginBottom:8,display:"flex",gap:8,alignItems:"center"}}><span style={{fontSize:12,color:"#525252"}}>Sort by:</span>{["name","territory","tier"].map(s=><button key={s} onClick={()=>setSort(s)} style={{fontSize:11,padding:"3px 10px",borderRadius:6,border:"none",cursor:"pointer",background:sort===s?"#2dd4bf22":"transparent",color:sort===s?"#2dd4bf":"#525252",fontFamily:"inherit"}}>{s}</button>)}</div>
      <Tbl columns={[{header:"Name",render:r=><span style={{fontWeight:600,color:"#e5e5e5"}}>{r.name}</span>},{header:"Email",render:r=><span style={{color:"#2dd4bf"}}>{r.email}</span>},{header:"Territory",render:r=>r.territory},{header:"Tier",render:r=> <Badge label={r.tier} color="#8b5cf6"/>},{header:"Rate",render:r=><span style={{fontFamily:"'JetBrains Mono',monospace",color:"#2dd4bf"}}>{(r.commissionRate*100).toFixed(1)}%</span>},{header:"",render:r=><Btn v="ghost" style={{fontSize:10,padding:"3px 8px"}} onClick={e=>{e.stopPropagation();startEdit(r)}}>Edit</Btn>}]} data={sortedReps}/></>}
  </div>;
}
...
function ExitReadinessPage({jobs,vendors,customers,lineItems}){
  ...
  return <div style={{animation:"fadeUp 0.4s"}}><Header title="Exit Readiness Score" sub="Buyer due diligence Ã¢ÂÂ systemized, transferable, auditable"/>
    <Card style={{marginBottom:24,background:"linear-gradient(135deg,#0a0a0a,#111111)",border:"1px solid #2dd4bf30"}}><div style={{display:"flex",alignItems:"center",gap:32}}><div style={{width:120,height:120,borderRadius:"50%",border:"4px solid #2dd4bf",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}><div style={{fontSize:28,fontWeight:800,color:"#2dd4bf",fontFamily:"'JetBrains Mono',monospace"}}>{Math.round(score)}</div><div style={{fontSize:11,color:"#525252"}}>/ 100</div></div><div style={{flex:1}}><div style={{fontSize:20,fontWeight:800,color:"#e5e5e5",marginBottom:4}}>Exit Readiness Assessment</div><div style={{fontSize:13,color:"#525252",marginBottom:12}}>{done} complete ÃÂ· {partial} in progress</div><Bar value={score} max={100} color="#2dd4bf" height={8}/><div style={{marginTop:8,fontSize:12,color:"#2dd4bf"}}>{score>=90?"Excellent Ã¢ÂÂ buyer-ready":score>=70?"Strong Ã¢ÂÂ minor items remaining":"In Progress"}</div></div><div style={{textAlign:"center",padding:"0 24px"}}><div style={{fontSize:11,color:"#525252",marginBottom:4}}>Valuation Impact</div><div style={{fontSize:13,fontWeight:600,color:"#34d399"}}>+1.5-2x multiple uplift</div></div></div></Card>
    <div className="resp-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>{criteria.map((s,si)=><Card key={si}><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:14}}>{s.category}</div>{s.items.map((item,ii)=><div key={ii} style={{display:"flex",alignItems:"center",gap:10,padding:"8px 0",borderBottom:ii<s.items.length-1?"1px solid #1e213044":"none"}}><div style={{width:20,height:20,borderRadius:6,flexShrink:0,background:item.status===true?"#34d399":item.status==="partial"?"#fbbf24":"#333333",display:"flex",alignItems:"center",justifyContent:"center"}}>{item.status===true&&<I n="check" s={12}/>}{item.status==="partial"&&<span style={{fontSize:10,fontWeight:700,color:"#fff"}}>~</span>}</div><div style={{flex:1}}><div style={{fontSize:13,color:item.status?"#d4d4d4":"#525252",fontWeight:500}}>{item.name}</div><div style={{fontSize:11,color:"#404040",marginTop:1}}>{item.note}</div></div></div>)}</Card>)}</div>
    <Card style={{marginTop:20,textAlign:"center",borderTop:"2px solid #2dd4bf"}}><div style={{fontSize:11,color:"#525252",textTransform:"uppercase",letterSpacing:2,marginBottom:4}}>Powered by</div><div style={{fontSize:20,fontWeight:800,color:"#2dd4bf",letterSpacing:1}}>DYFRENT</div></Card>
  </div>;
}

// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
// QUICKBOOKS SETUP Ã¢ÂÂ Integration Guide + OAuth Flow Docs
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function QBSetupPage({notify,qbConfig,setQbConfig}){
  ...
  return <div style={{animation:"fadeUp 0.4s"}}><Header title="QuickBooks Integration" sub="Enter your API credentials to connect Ã¢ÂÂ invoices and POs push directly"/>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
        <div style={{display:"flex",alignItems:"center",gap:12}}>
          ...
          <div>
            ...
            <div style={{fontSize:13,color:"#525252",marginTop:2}}>{qbConfig.connected?"Push POs and Invoices from the Documents page":"Enter your credentials below to connect"}</div>
          </div>
        </div>
    ...
    <Card style={{marginBottom:20}}>
      ...
      <div className="resp-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:16}}>
        <div>
          <label style={{fontSize:12,color:"#525252",display:"block",marginBottom:6,fontWeight:500}}>Client ID</label>
          ...
          <div style={{fontSize:11,color:"#404040",marginTop:4}}>From developer.intuit.com Ã¢ÂÂ My Apps Ã¢ÂÂ Keys & credentials</div>
        </div>
        <div>
          <label style={{fontSize:12,color:"#525252",display:"block",marginBottom:6,fontWeight:500}}>Client Secret</label>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:16,marginBottom:16}}>
        <div>
          <label style={{fontSize:12,color:"#525252",display:"block",marginBottom:6,fontWeight:500}}>Realm ID (Company ID)</label>
          <input value={qbConfig.realmId} onChange={e=>updateField("realmId",e.target.value)} placeholder="1234567890" style={inputStyle}/>
          <div style={{fontSize:11,color:"#404040",marginTop:4}}>Found in the URL when logged into QBO</div>
        </div>
        <div>
          <label style={{fontSize:12,color:"#525252",display:"block",marginBottom:6,fontWeight:500}}>Access Token</label>
          ...
          <div style={{fontSize:11,color:"#404040",marginTop:4}}>OAuth 2.0 bearer token (expires in 1hr)</div>
        </div>
        <div>
          <label style={{fontSize:12,color:"#525252",display:"block",marginBottom:6,fontWeight:500}}>Refresh Token</label>
          ...
          <div style={{fontSize:11,color:"#404040",marginTop:4}}>Used to get new access tokens (expires in 100 days)</div>
        </div>
      </div>
      <div style={{display:"flex",gap:8,alignItems:"center"}}>
    ...
    <Card style={{marginBottom:16}}><div style={{fontSize:16,fontWeight:700,color:"#e5e5e5",marginBottom:12}}>How to Get Your Credentials</div>
      <div style={{display:"flex",flexDirection:"column",gap:16}}>
        ...
        <div><div style={{fontSize:13,fontWeight:700,color:"#2dd4bf",marginBottom:4}}>Step 2: Get Your Realm ID</div><div style={{fontSize:13,color:"#a3a3a3",lineHeight:1.7}}>Log into QuickBooks Online. Look at the URL Ã¢ÂÂ it contains your Realm ID (Company ID) as a number like <span style={{fontFamily:"'JetBrains Mono',monospace",color:"#2dd4bf"}}>https://app.qbo.intuit.com/app/homepage?companyId=<strong>1234567890</strong></span></div></div>
        <div><div style={{fontSize:13,fontWeight:700,color:"#2dd4bf",marginBottom:4}}>Step 3: Generate Access Token</div><div style={{fontSize:13,color:"#a3a3a3",lineHeight:1.7}}>In the Intuit Developer portal, go to your app's <strong>OAuth 2.0 Playground</strong> (under "Test" section). Select scopes <span style={{fontFamily:"'JetBrains Mono',monospace",color:"#2dd4bf"}}>com.intuit.quickbooks.accounting</span>, authorize, and copy both the Access Token and Refresh Token.</div></div>
        <div><div style={{fontSize:13,fontWeight:700,color:"#2dd4bf",marginBottom:4}}>Step 4: Paste & Connect</div><div style={{fontSize:13,color:"#a3a3a3",lineHeight:1.7}}>Paste all credentials above and click "Test Connection." If successful, you can push POs and Invoices directly from the Documents page. Access tokens expire in 1 hour Ã¢ÂÂ refresh in the OAuth Playground when needed.</div></div>
      </div>
    </Card>
    ...
    <Card><div style={{fontSize:14,fontWeight:700,color:"#e5e5e5",marginBottom:12}}>API Endpoints Used</div><div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:12,color:"#a3a3a3",background:"#000000",padding:16,borderRadius:8,lineHeight:2}}>
      <div><span style={{color:"#34d399"}}>POST</span> <span style={{color:"#2dd4bf"}}>/v3/company/{"{realmId}"}/invoice</span> Ã¢ÂÂ Create invoice</div>
      <div><span style={{color:"#34d399"}}>POST</span> <span style={{color:"#2dd4bf"}}>/v3/company/{"{realmId}"}/purchaseorder</span> Ã¢ÂÂ Create PO</div>
      <div><span style={{color:"#a78bfa"}}>GET</span>  <span style={{color:"#2dd4bf"}}>/v3/company/{"{realmId}"}/companyinfo/{"{realmId}"}</span> Ã¢ÂÂ Test connection</div>
      <div><span style={{color:"#fbbf24"}}>POST</span> <span style={{color:"#2dd4bf"}}>/oauth2/v1/tokens/bearer</span> Ã¢ÂÂ Token refresh</div>
    </div></Card>

    <Card style={{marginTop:16,borderLeft:"3px solid #2dd4bf"}}><div style={{fontSize:13,color:"#a3a3a3",lineHeight:1.7}}>
      <strong style={{color:"#2dd4bf"}}>How it works:</strong> When you push a PO or Invoice from the Documents page, the system sends the document data to the QuickBooks API using your access token. QuickBooks creates the record and returns a confirmation. The Job Record stays the source of truth Ã¢ÂÂ QB receives the finalized document. One entry, one record, everything flows.
    </div></Card>
  </div>;
}
