...
const INIT_VENDORS = [
  { id: "V001", name: "Smith System", contact: "Sales Dept", email: "info@smithsystem.com", phone: "(800) 328-1061", category: "Collaborative Tables", address: "1714 E 14th St, Plano, TX 75074", discountRate: 0.38, discountType: "tiered", discountNotes: "38% off list standard. 40% on $25K+. 42% on $50K+. Free freight full truckloads." },
  { id: "V002", name: "Haskell Education", contact: "Sales Dept", email: "info@haskelleducation.com", phone: "(800) 334-8988", category: "Classroom Furniture", address: "1 Haskell Dr, Pittsburgh, PA 15205", discountRate: 0.35, discountType: "tiered", discountNotes: "35% off list. 38% on $15K+. Free freight $10K+. Custom color upcharge 5%." },
  { id: "V003", name: "National Public Seating", contact: "Sales Dept", email: "info@nps.com", phone: "(800) 235-5912", category: "Seating & Staging", address: "901 Janesville Ave, Fort Atkinson, WI 53538", discountRate: 0.40, discountType: "tiered", discountNotes: "40% off list. 45% on 200+ units. Staging 35% off. Folding chairs 42% on 500+." },
  { id: "V004", name: "KI", contact: "Sales Dept", email: "info@ki.com", phone: "(800) 424-2432", category: "Education & Office", address: "1330 Bellevue St, Green Bay, WI 54302", discountRate: 0.45, discountType: "project", discountNotes: "45% off list. Project pricing $50K+. Education discount +3%. Lead time 6-8 wks custom." },
  { id: "V005", name: "MooreCo", contact: "Sales Dept", email: "info@mooreco.com", phone: "(800) 749-2258", category: "Whiteboards & AV", address: "2885 Lorraine Ave, Temple, TX 76501", discountRate: 0.36, discountType: "tiered", discountNotes: "36% off list. Whiteboards 40% on 20+. AV carts 33%. Free freight $7,500+." },
  { id: "V006", name: "Jonti-Craft", contact: "Sales Dept", email: "info@jonti-craft.com", phone: "(800) 543-4149", category: "Early Childhood", address: "171 Highway 68, Wabasso, MN 56293", discountRate: 0.40, discountType: "tiered", discountNotes: "40% off list. 43% on $10K+ classroom pkgs. Free freight $5K+." },
  { id: "V007", name: "Bretford", contact: "Sales Dept", email: "info@bretford.com", phone: "(800) 521-9614", category: "Technology & Charging", address: "11000 Seymour Ave, Franklin Park, IL 60131", discountRate: 0.38, discountType: "tiered", discountNotes: "38% off list. Charging carts 40% on 50+. Power/data 35%. E-Rate eligible." },
  { id: "V008", name: "Diversified Spaces", contact: "Sales Dept", email: "info@diversifiedspaces.com", phone: "(800) 253-3684", category: "Science Lab Furniture", address: "Boyertown, PA 19512", discountRate: 0.35, discountType: "project", discountNotes: "35% off list. Custom lab builds per project. Fume hoods separate pricing." },
  { id: "V009", name: "Fleetwood", contact: "Sales Dept", email: "info@fleetwood.com", phone: "(800) 257-6390", category: "Classroom & Mobile", address: "Holland, MI 49423", discountRate: 0.37, discountType: "percentage", discountNotes: "37% off list. Mobile carts and tables. Teacher desks 35% off." },
  { id: "V010", name: "Columbia Manufacturing", contact: "Sales Dept", email: "info@columbiamfg.com", phone: "(800) 882-3056", category: "Classroom Furniture", address: "Silver Creek, NY 14136", discountRate: 0.35, discountType: "tiered", discountNotes: "35% off list. Made in USA. 38% on 300+ units." },
  { id: "V011", name: "Scholar Craft", contact: "Sales Dept", email: "info@scholarcraft.com", phone: "(800) 225-7188", category: "Classroom Furniture", address: "Birmingham, AL 35210", discountRate: 0.40, discountType: "tiered", discountNotes: "40% off list. 43% on 500+ chair orders. Budget alternative for high-volume refreshes." },
  { id: "V012", name: "Wenger", contact: "Sales Dept", email: "info@wengercorp.com", phone: "(800) 733-0393", category: "Music & Performing Arts", address: "555 Park Dr, Owatonna, MN 55060", discountRate: 0.30, discountType: "project", discountNotes: "30% off list. Music chairs 33% on full-room. Practice rooms: project quote required." },
  { id: "V013", name: "Palmer Hamilton", contact: "Sales Dept", email: "info@palmerhamilton.com", phone: "(800) 788-1028", category: "Cafeteria & Tables", address: "Elkhorn, WI 53121", discountRate: 0.36, discountType: "tiered", discountNotes: "36% off list. Cafeteria tables 40% on 50+. Mobile bench 38%. Made in WI." },
  { id: "V014", name: "BioFit", contact: "Sales Dept", email: "info@biofit.com", phone: "(800) 597-0246", category: "Lab & STEM Seating", address: "Waterville, OH 43566", discountRate: 0.33, discountType: "tiered", discountNotes: "33% off list. Lab stools 36% on 100+. STEM seating. Ergonomic specialty." },
  { id: "V015", name: "Screenflex", contact: "Sales Dept", email: "info@screenflex.com", phone: "(800) 553-0110", category: "Room Dividers", address: "Lake Zurich, IL 60047", discountRate: 0.30, discountType: "tiered", discountNotes: "30% off list. 33% on 10+. Local IL manufacturer." },
  { id: "V016", name: "ECR4Kids", contact: "Sales Dept", email: "info@ecr4kids.com", phone: "(855) 327-4543", category: "Early Childhood", address: "San Diego, CA 92127", discountRate: 0.42, discountType: "tiered", discountNotes: "42% off list. 45% on classroom pkgs $8K+. Quick ship program." },
  { id: "V017", name: "Academia", contact: "Sales Dept", email: "info@academiafurniture.com", phone: "(800) 448-0980", category: "Classroom Furniture", address: "Paoli, PA 19301", discountRate: 0.36, discountType: "percentage", discountNotes: "36% off list. Desks, chairs, combos. Budget option." },
  { id: "V018", name: "Allied Products", contact: "Sales Dept", email: "info@alliedprod.com", phone: "(800) 247-5268", category: "Storage & Casework", address: "Fort Worth, TX 76106", discountRate: 0.34, discountType: "percentage", discountNotes: "34% off list. Lockers, shelving, storage cabinets." },
  { id: "V019", name: "AmTab Manufacturing", contact: "Sales Dept", email: "info@amtab.com", phone: "(800) 424-2531", category: "Cafeteria & Folding Tables", address: "Schiller Park, IL 60176", discountRate: 0.38, discountType: "tiered", discountNotes: "38% off list. 42% on $20K+ cafeteria. Mobile stages 35%. IL manufacturer." },
  { id: "V020", name: "Artopex", contact: "Sales Dept", email: "info@artopex.com", phone: "(800) 363-9897", category: "Administration Office", address: "Granby, QC Canada", discountRate: 0.40, discountType: "project", discountNotes: "40% off list. Admin office furniture. Project pricing on full fit-outs." },
  { id: "V021", name: "Carpets for Kids", contact: "Sales Dept", email: "info@carpetsforkids.com", phone: "(800) 321-2318", category: "Carpets & Rugs", address: "Dalton, GA 30720", discountRate: 0.35, discountType: "tiered", discountNotes: "35% off list. 40% on $5K+ orders. Classroom rugs and carpet squares." },
  { id: "V022", name: "Correll", contact: "Sales Dept", email: "info@correll.com", phone: "(800) 344-1692", category: "Activity & Folding Tables", address: "Raleigh, NC 27616", discountRate: 0.38, discountType: "tiered", discountNotes: "38% off list. Activity tables 40% on 50+. Folding 42% on 100+. Quick ship." },
  { id: "V023", name: "Da-Lite", contact: "Sales Dept", email: "info@da-lite.com", phone: "(800) 622-3737", category: "AV & Projection", address: "Warsaw, IN 46580", discountRate: 0.32, discountType: "percentage", discountNotes: "32% off list. Screens, AV mounts. E-Rate eligible." },
  { id: "V024", name: "Eurotech Seating", contact: "Sales Dept", email: "info@eurotech.com", phone: "(800) 637-7002", category: "Office Seating", address: "New London, NC 28127", discountRate: 0.40, discountType: "tiered", discountNotes: "40% off list. 43% on 50+. Admin/teacher chairs. Ergonomic task seating." },
  { id: "V025", name: "Hamilton Buhl", contact: "Sales Dept", email: "info@hamiltonbuhl.com", phone: "(800) 631-0868", category: "AV & Headphones", address: "Fairfield, NJ 07004", discountRate: 0.35, discountType: "percentage", discountNotes: "35% off list. Headphones, listening centers, STEM kits." },
  { id: "V026", name: "Luxor", contact: "Sales Dept", email: "info@luxorfurn.com", phone: "(800) 867-2018", category: "AV Carts & Stands", address: "Waukegan, IL 60085", discountRate: 0.37, discountType: "tiered", discountNotes: "37% off list. 40% on 20+. Standing desks, whiteboards. IL manufacturer." },
  { id: "V027", name: "SICO", contact: "Sales Dept", email: "info@sicoinc.com", phone: "(800) 328-6138", category: "Stages & Mobile", address: "Minneapolis, MN 55420", discountRate: 0.30, discountType: "project", discountNotes: "30% off list. Portable stages. Project pricing on installations." },
  { id: "V028", name: "Muzo", contact: "Sales Dept", email: "info@muzo-works.com", phone: "(855) 689-6738", category: "Collaborative & Soft Seating", address: "Charlotte, NC 28217", discountRate: 0.35, discountType: "percentage", discountNotes: "35% off list. Kite tables, collaborative and soft seating modules." },
  { id: "V029", name: "Mitchell Furniture", contact: "Sales Dept", email: "info@mitchellfurniture.com", phone: "(800) 327-3032", category: "Library Furniture", address: "Milwaukee, WI 53215", discountRate: 0.32, discountType: "project", discountNotes: "32% off list. Custom library installs. WI manufacturer. Full library fit-out quotes." },
  { id: "V030", name: "Joy Carpets", contact: "Sales Dept", email: "info@joycarpets.com", phone: "(800) 645-2787", category: "Carpets & Rugs", address: "Fort Oglethorpe, GA 30742", discountRate: 0.35, discountType: "percentage", discountNotes: "35% off list. Educational and themed carpets." },
];
  ...
  useEffect(() => {
    const loadFromDb = async () => {
      try {
        ...
        try {
          const flagCheck = await fetch(SUPA_URL+'/rest/v1/reps?id=eq.SEED_FLAG_V4&select=id', {headers:{'apikey':SUPA_KEY,'Authorization':'Bearer '+SUPA_KEY}});
        ...
        if (needsReseed) {
          ...
          try { await fetch(SUPA_URL+'/rest/v1/reps',{method:'POST',headers:{'apikey':SUPA_KEY,'Authorization':'Bearer '+SUPA_KEY,'Content-Type':'application/json','Prefer':'resolution=merge-duplicates'},body:JSON.stringify({id:'SEED_FLAG_V4',name:'_SEED_DONE_',email:'',territory:'',commission_rate:0,tier:'system'})}); } catch {}
        }
...
function DocumentsPage({jobs,lineItems,vendors,customers,reps,getJobItems,notify,qbConfig,setPage,triggerPrint}){
  ...
  const handleExportPDF=(doc)=>{
    ...
    const isComm=doc.type==="commission";
  ...
  return <div style={{animation:"fadeUp 0.4s"}}><Header title="Documents" sub="Quotes, Purchase Orders, Invoices — all auto-drafted from job records"/>
    <div style={{display:"flex",gap:4,marginBottom:20,background:"#12141b",padding:4,borderRadius:10,width:"fit-content"}}>{[["quotes","Quotes"],["pos","Purchase Orders"],["invoices","Invoices"],["commissions","Commission Statements"],["preview","Document Preview"]].map(([id,label])=><button key={id} onClick={()=>setTab(id)} style={{padding:"8px 16px",borderRadius:8,border:"none",cursor:"pointer",background:tab===id?"#c8a25c":"transparent",color:tab===id?"#0a0c10":"#6b7280",fontSize:13,fontWeight:tab===id?600:400,fontFamily:"inherit"}}>{label}</button>)}</div>
    ...
    {tab==="commissions"&&reps.filter(r=>r.commissionRate>0).map(rep=>{const rj=jobs.filter(j=>j.salesRep===rep.id);const totalRev=rj.reduce((s,j)=>s+getJobFinancials(j.id).totalRevenue,0);const comm=totalRev*rep.commissionRate;return <Card key={rep.id} style={{marginBottom:16}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}><div><span style={{fontSize:14,fontWeight:700,color:"#f5f5f4"}}>{rep.name}</span><span style={{fontSize:12,color:"#6b7280",marginLeft:10}}>{rep.territory} · {rj.length} jobs · {fmt(totalRev)} revenue · {fmt(comm)} commission</span></div><Btn onClick={()=>{const items=rj.map(j=>({description:j.name+' ('+((customers.find(c=>c.id===j.customer))?.name||'')+')' ,displayQty:1,displayPrice:getJobFinancials(j.id).totalRevenue*rep.commissionRate}));setPreviewDoc({type:"commission",data:{rep,items,total:comm,docNum:genDocNum('COMM-')},job:{id:'ALL',name:rep.name+' Commission Statement',notes:'Period: '+new Date().toLocaleDateString()}});setTab("preview")}}><I n="file" s={14}/> Generate Statement</Btn></div><Bar value={rj.filter(j=>j.paymentStatus==="paid").length} max={rj.length||1} color="#059669" height={3}/></Card>})}

    {tab==="preview"&&previewDoc&&<Card style={{border:"1px solid #c8a25c30"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}><div style={{fontSize:16,fontWeight:700,color:"#c8a25c"}}>{previewDoc.type==="quote"?"PROJECT QUOTE":previewDoc.type==="po"?"PURCHASE ORDER":previewDoc.type==="commission"?"COMMISSION STATEMENT":"INVOICE"} — Draft Preview</div><div style={{display:"flex",gap:8}}><Btn onClick={()=>handleExportPDF(previewDoc)}><I n="download" s={14}/> Export PDF</Btn>{previewDoc.type!=="quote"&&<Btn v={qbConfig.connected?"primary":"secondary"} onClick={()=>qbConfig.connected?pushToQB(previewDoc):setPage("qbsetup")} style={pushing?{opacity:0.6,pointerEvents:"none"}:{}}><I n="send" s={14}/> {pushing?"Pushing...":qbConfig.connected?"Push to QuickBooks":"Connect QB First"}</Btn>}</div></div>
      <div style={{background:"#fff",color:"#111",borderRadius:8,padding:32,fontFamily:"'DM Sans',sans-serif"}}><div style={{display:"flex",justifyContent:"space-between",borderBottom:"2px solid #c8a25c",paddingBottom:16,marginBottom:20}}><div><div style={{fontSize:20,fontWeight:800}}>MIDWEST EDUCATIONAL FURNISHINGS</div><div style={{fontSize:11,color:"#999",marginTop:2}}>Designing Spaces | Building Futures</div><div style={{fontSize:12,color:"#666",marginTop:4}}>(847) 847-1865 · info@mwfurnishings.com · www.mwfurnishings.com</div></div><div style={{textAlign:"right"}}><div style={{fontSize:14,fontWeight:700,color:"#c8a25c",textTransform:"uppercase"}}>{previewDoc.type==="quote"?"Project Quote":previewDoc.type==="po"?"Purchase Order":previewDoc.type==="commission"?"Commission Statement":"Invoice"}</div><div style={{fontSize:12,fontWeight:600,color:"#333"}}>{previewDoc.data.docNum||""}</div><div style={{fontSize:12,color:"#666",marginTop:4}}>Date: {new Date().toLocaleDateString()}</div><div style={{fontSize:12,color:"#666"}}>Job: {previewDoc.job.id}</div>{previewDoc.type==="quote"&&<div style={{fontSize:11,color:"#999",marginTop:2}}>Valid for 30 days</div>}</div></div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:24,marginBottom:24}}><div><div style={{fontSize:11,fontWeight:700,color:"#999",textTransform:"uppercase",marginBottom:4}}>{previewDoc.type==="quote"?"Prepared For":previewDoc.type==="po"?"Vendor":previewDoc.type==="commission"?"Sales Rep":"Bill To"}</div><div style={{fontSize:13,fontWeight:600}}>{previewDoc.type==="quote"?previewDoc.data.customer?.name:previewDoc.type==="po"?previewDoc.data.vendor?.name:previewDoc.type==="commission"?previewDoc.data.rep?.name:previewDoc.data.customer?.name}</div>{(previewDoc.type==="quote"?previewDoc.data.customer?.address:previewDoc.type==="po"?previewDoc.data.vendor?.address:previewDoc.data.customer?.address)&&<div style={{fontSize:11,color:"#888",marginTop:2}}>{previewDoc.type==="quote"?previewDoc.data.customer?.address:previewDoc.type==="po"?previewDoc.data.vendor?.address:previewDoc.data.customer?.address}</div>}</div><div><div style={{fontSize:11,fontWeight:700,color:"#999",textTransform:"uppercase",marginBottom:4}}>Project</div><div style={{fontSize:13,fontWeight:600}}>{previewDoc.job.name}</div>{previewDoc.job.notes&&<div style={{fontSize:11,color:"#888",marginTop:2}}>{previewDoc.job.notes}</div>}</div></div>
...
function SalesPortalPage({jobs,reps,customers,lineItems,getJobFinancials,vendors}){
  ...
  const earnedComm=paidRev*rep.commissionRate;
  const projectedComm=totalRev*rep.commissionRate;

  return <div style={{animation:"fadeUp 0.4s"}}><Header title="Sales Portal" sub="Per-rep dashboard — pipeline, deliveries, commissions"/>
    <div style={{display:"flex",gap:8,marginBottom:20,flexWrap:"wrap"}}>{reps.filter(r=>r.commissionRate>0).map(r=><button key={r.id} onClick={()=>setActiveRep(r.id)} style={{padding:"8px 16px",borderRadius:8,cursor:"pointer",background:activeRep===r.id?"linear-gradient(135deg,#c8a25c,#b8923c)":"#12141b",color:activeRep===r.id?"#0a0c10":"#9ca3af",fontSize:13,fontWeight:activeRep===r.id?600:400,fontFamily:"inherit",border:activeRep===r.id?"none":"1px solid #1e2130"}}>{r.name}</button>)}</div>
    <Card style={{marginBottom:20,background:"linear-gradient(135deg,#12141b,#1a1d27)"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:16}}><div><div style={{fontSize:20,fontWeight:800,color:"#f5f5f4"}}>{rep.name}</div><div style={{fontSize:13,color:"#6b7280"}}>{rep.territory} · {rep.tier} · {pct(rep.commissionRate*100)} rate</div></div><div style={{display:"flex",gap:20,flexWrap:"wrap"}}><div style={{textAlign:"center"}}><div style={{fontSize:10,color:"#6b7280"}}>Pipeline</div><div style={{fontSize:22,fontWeight:700,color:"#c8a25c",fontFamily:"'DM Mono',monospace"}}>{fmt(totalRev)}</div></div><div style={{textAlign:"center"}}><div style={{fontSize:10,color:"#6b7280"}}>Quoting</div><div style={{fontSize:22,fontWeight:700,color:"#8b5cf6",fontFamily:"'DM Mono',monospace"}}>{quotingJobs.length}</div></div><div style={{textAlign:"center"}}><div style={{fontSize:10,color:"#6b7280"}}>Active</div><div style={{fontSize:22,fontWeight:700,color:"#2563eb",fontFamily:"'DM Mono',monospace"}}>{activeJobs.length}</div></div><div style={{textAlign:"center"}}><div style={{fontSize:10,color:"#6b7280"}}>Earned</div><div style={{fontSize:22,fontWeight:700,color:"#059669",fontFamily:"'DM Mono',monospace"}}>{fmt(earnedComm)}</div></div><div style={{textAlign:"center"}}><div style={{fontSize:10,color:"#6b7280"}}>Projected</div><div style={{fontSize:22,fontWeight:700,color:"#d97706",fontFamily:"'DM Mono',monospace"}}>{fmt(projectedComm)}</div></div></div></div></Card>
    ...
    <Card><div style={{fontSize:14,fontWeight:700,color:"#f5f5f4",marginBottom:12}}>All Jobs</div><Tbl columns={[
      ...
      {header:"Commission",render:r=><span style={{fontFamily:"'DM Mono',monospace",color:r.paymentStatus==="paid"?"#059669":"#c8a25c"}}>{fmt(getJobFinancials(r.id).totalRevenue*rep.commissionRate)}</span>},
    ]} data={rj}/></Card>
  </div>;
}
