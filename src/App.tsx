...
function DiscInput({initial,onCommit,style}){
  ...
  return <input type="number" value={val} onChange={e=>{setVal(e.target.value);const pct=parseFloat(e.target.value);if(!isNaN(pct))onCommit(pct)}} style={style} placeholder="0" min="0" max="100" step="1"/>;
}
